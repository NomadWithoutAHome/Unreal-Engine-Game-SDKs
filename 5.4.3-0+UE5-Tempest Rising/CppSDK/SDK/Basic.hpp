...
namespace Offsets
{
	constexpr int32 GObjects          = 0x09240360;
	constexpr int32 AppendString      = 0x0119CC30;
	constexpr int32 GNames            = 0x091895C0;
	constexpr int32 GWorld            = 0x093C28F8;
	constexpr int32 ProcessEvent      = 0x013894A0;
