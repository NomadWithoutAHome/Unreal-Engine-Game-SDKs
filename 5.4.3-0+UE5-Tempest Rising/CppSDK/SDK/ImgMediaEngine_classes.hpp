...
{
public:
	float                                         LODBias;                                           // 0x00B0(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UImgMediaPlaybackComponent, LODBias) == 0x0000B0, "Member 'UImgMediaPlaybackComponent::LODBias' has a wrong offset!");
