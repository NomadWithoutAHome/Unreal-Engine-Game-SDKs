...
{
public:
	EARTextureType                                TextureType;                                       // 0x00B0(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_B1[0x7];                                       // 0x00B1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UMaterialInterface*                     PassthroughMaterial;                               // 0x00B8(0x0008)(Edit, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UMaterialInterface*                     PassthroughMaterialExternalTexture;                // 0x00C0(0x0008)(Edit, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FLinearColor                           PassthroughDebugColor;                             // 0x00C8(0x0010)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TArray<class UPrimitiveComponent*>            AffectedComponents;                                // 0x00D8(0x0010)(ExportObject, ZeroConstructor, Transient, ContainsInstancedReference, UObjectWrapper, NativeAccessSpecifierPrivate)
	TArray<class UPrimitiveComponent*>            PendingComponents;                                 // 0x00E8(0x0010)(ExportObject, ZeroConstructor, Transient, ContainsInstancedReference, UObjectWrapper, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UPassthroughMaterialUpdateComponent) == 0x0000F8, "Wrong size on UPassthroughMaterialUpdateComponent");
static_assert(offsetof(UPassthroughMaterialUpdateComponent, TextureType) == 0x0000B0, "Member 'UPassthroughMaterialUpdateComponent::TextureType' has a wrong offset!");
static_assert(offsetof(UPassthroughMaterialUpdateComponent, PassthroughMaterial) == 0x0000B8, "Member 'UPassthroughMaterialUpdateComponent::PassthroughMaterial' has a wrong offset!");
static_assert(offsetof(UPassthroughMaterialUpdateComponent, PassthroughMaterialExternalTexture) == 0x0000C0, "Member 'UPassthroughMaterialUpdateComponent::PassthroughMaterialExternalTexture' has a wrong offset!");
static_assert(offsetof(UPassthroughMaterialUpdateComponent, PassthroughDebugColor) == 0x0000C8, "Member 'UPassthroughMaterialUpdateComponent::PassthroughDebugColor' has a wrong offset!");
static_assert(offsetof(UPassthroughMaterialUpdateComponent, AffectedComponents) == 0x0000D8, "Member 'UPassthroughMaterialUpdateComponent::AffectedComponents' has a wrong offset!");
static_assert(offsetof(UPassthroughMaterialUpdateComponent, PendingComponents) == 0x0000E8, "Member 'UPassthroughMaterialUpdateComponent::PendingComponents' has a wrong offset!");
