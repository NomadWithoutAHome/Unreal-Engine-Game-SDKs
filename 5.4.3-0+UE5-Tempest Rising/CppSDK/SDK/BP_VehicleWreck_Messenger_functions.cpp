...
#include "BP_VehicleWreck_Messenger_classes.hpp"
#include "BP_VehicleWreck_Messenger_parameters.hpp"
...
void ABP_VehicleWreck_Messenger_C::BndEvt__BP_VehicleWreck_Peacekeeper_SkeletalMesh_K2Node_ComponentBoundEvent_0_ComponentHitSignature__DelegateSignature(class UPrimitiveComponent* HitComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, const struct FVector& NormalImpulse, const struct FHitResult& Hit_0)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_VehicleWreck_Messenger_C", "BndEvt__BP_VehicleWreck_Peacekeeper_SkeletalMesh_K2Node_ComponentBoundEvent_0_ComponentHitSignature__DelegateSignature");

	Params::BP_VehicleWreck_Messenger_C_BndEvt__BP_VehicleWreck_Peacekeeper_SkeletalMesh_K2Node_ComponentBoundEvent_0_ComponentHitSignature__DelegateSignature Parms{};
...
// Function BP_VehicleWreck_Messenger.BP_VehicleWreck_Messenger_C.Dissolve Main__FinishedFunc
// (BlueprintEvent)

void ABP_VehicleWreck_Messenger_C::Dissolve_Main__FinishedFunc()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_VehicleWreck_Messenger_C", "Dissolve Main__FinishedFunc");

	UObject::ProcessEvent(Func, nullptr);
}


// Function BP_VehicleWreck_Messenger.BP_VehicleWreck_Messenger_C.Dissolve Main__Treat as Dissolved__EventFunc
// (BlueprintEvent)

void ABP_VehicleWreck_Messenger_C::Dissolve_Main__Treat_as_Dissolved__EventFunc()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_VehicleWreck_Messenger_C", "Dissolve Main__Treat as Dissolved__EventFunc");

	UObject::ProcessEvent(Func, nullptr);
}


// Function BP_VehicleWreck_Messenger.BP_VehicleWreck_Messenger_C.Dissolve Main__UpdateFunc
// (BlueprintEvent)

void ABP_VehicleWreck_Messenger_C::Dissolve_Main__UpdateFunc()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_VehicleWreck_Messenger_C", "Dissolve Main__UpdateFunc");
...
void ABP_VehicleWreck_Messenger_C::ExecuteUbergraph_BP_VehicleWreck_Messenger(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_VehicleWreck_Messenger_C", "ExecuteUbergraph_BP_VehicleWreck_Messenger");

	Params::BP_VehicleWreck_Messenger_C_ExecuteUbergraph_BP_VehicleWreck_Messenger Parms{};
...
// Parameters:
// TArray<class FName>&                    Bones_to_Hide                                          (BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
...
void ABP_VehicleWreck_Messenger_C::Initial_VETI_Aircraft_Destruction_Force(TArray<class FName>& Bones_to_Hide, class USkeletalMeshComponent* Skeletal_Mesh, class FName Bone_Name, class UStaticMeshComponent* Static_Mesh__TEMP_, const struct FVector& Rotation_Force_Axis_0, double Rotation_Force_Multiplier_0, TArray<bool>& Rotation_Force_Locked_Axis_0, const struct FVector& Forward_Force_Direction_0, double Forward_Force_0, TArray<bool>& Apply_Forward_Force_to_Parts, TArray<double>& Forward_Force_to_Parts_Multiplier, TArray<class UStaticMeshComponent*>& Parts_Meshes, double Parts_Meshes_Dir_Force_Angle, double Parts_Meshes_Dir_Force_Multiplier, double Parts_Meshes_Ang_Force_Multiplier)
{
	...
	Bones_to_Hide = std::move(Parms.Bones_to_Hide);
...
// Function BP_VehicleWreck_Messenger.BP_VehicleWreck_Messenger_C.ReceiveBeginPlay
// (Event, Protected, BlueprintEvent)

void ABP_VehicleWreck_Messenger_C::ReceiveBeginPlay()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_VehicleWreck_Messenger_C", "ReceiveBeginPlay");
...
void ABP_VehicleWreck_Messenger_C::ReceiveTick(float DeltaSeconds)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_VehicleWreck_Messenger_C", "ReceiveTick");

	Params::BP_VehicleWreck_Messenger_C_ReceiveTick Parms{};
...
// Function BP_VehicleWreck_Messenger.BP_VehicleWreck_Messenger_C.UserConstructionScript
// (Event, Public, BlueprintCallable, BlueprintEvent)

void ABP_VehicleWreck_Messenger_C::UserConstructionScript()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_VehicleWreck_Messenger_C", "UserConstructionScript");
