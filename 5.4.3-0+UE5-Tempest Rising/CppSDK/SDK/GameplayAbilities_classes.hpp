...
public:
	...
	class FName                                   AffectedAnimInstanceTag;                           // 0x0148(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_150[0x1A8];                                    // 0x0150(0x01A8)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_558[0x220];                                    // 0x0558(0x0220)(Fixing Size After Last Property [ Dumper-7 ])
	...
	struct FActiveGameplayEffectsContainer        ActiveGameplayEffects;                             // 0x0888(0x0300)(Net, Protected, NativeAccessSpecifierProtected)
	...
	struct FMinimalReplicationTagCountMap         MinimalReplicationTags;                            // 0x1038(0x0068)(Net, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
	...
	struct FMinimalReplicationTagCountMap         ReplicatedLooseTags;                               // 0x10C0(0x0068)(Net, ContainsInstancedReference, NativeAccessSpecifierPrivate)
	uint8                                         Pad_1128[0x8];                                     // 0x1128(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FReplicatedPredictionKeyMap            ReplicatedPredictionKeyMap;                        // 0x1130(0x0118)(Net, Transient, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UAbilitySystemComponent, AffectedAnimInstanceTag) == 0x000148, "Member 'UAbilitySystemComponent::AffectedAnimInstanceTag' has a wrong offset!");
...
static_assert(offsetof(UAbilitySystemComponent, ActiveGameplayCues) == 0x000B88, "Member 'UAbilitySystemComponent::ActiveGameplayCues' has a wrong offset!");
static_assert(offsetof(UAbilitySystemComponent, MinimalReplicationGameplayCues) == 0x000CB0, "Member 'UAbilitySystemComponent::MinimalReplicationGameplayCues' has a wrong offset!");
static_assert(offsetof(UAbilitySystemComponent, BlockedAbilityBindings) == 0x000F00, "Member 'UAbilitySystemComponent::BlockedAbilityBindings' has a wrong offset!");
static_assert(offsetof(UAbilitySystemComponent, MinimalReplicationTags) == 0x001038, "Member 'UAbilitySystemComponent::MinimalReplicationTags' has a wrong offset!");
...
static_assert(offsetof(UAbilitySystemComponent, ReplicatedPredictionKeyMap) == 0x001130, "Member 'UAbilitySystemComponent::ReplicatedPredictionKeyMap' has a wrong offset!");
