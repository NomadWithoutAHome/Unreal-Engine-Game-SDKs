...
static_assert(sizeof(UGameplayCameraComponent) == 0x000250, "Wrong size on UGameplayCameraComponent");
static_assert(offsetof(UGameplayCameraComponent, Camera) == 0x000240, "Member 'UGameplayCameraComponent::Camera' has a wrong offset!");
static_assert(offsetof(UGameplayCameraComponent, EvaluationContext) == 0x000248, "Member 'UGameplayCameraComponent::EvaluationContext' has a wrong offset!");
...
static_assert(offsetof(UGameplayCameraSystemComponent, Evaluator) == 0x000240, "Member 'UGameplayCameraSystemComponent::Evaluator' has a wrong offset!");
