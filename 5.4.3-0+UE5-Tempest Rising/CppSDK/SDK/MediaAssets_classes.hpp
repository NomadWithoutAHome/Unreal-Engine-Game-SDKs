...
public:
	...
	class USoundClass*                            SoundClass;                                        // 0x00B0(0x0008)(Edit, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         Volume;                                            // 0x00B8(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_BC[0x4];                                       // 0x00BC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FSubtitleCue>                   Subtitles;                                         // 0x00C0(0x0010)(Edit, ZeroConstructor, Protected, NativeAccessSpecifierProtected)
	uint8                                         bOverride_PlaceholderLength : 1;                   // 0x00D0(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, EditConst, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         Pad_D1[0x3];                                       // 0x00D1(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         PlaceholderLength;                                 // 0x00D4(0x0004)(Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)

public:
	void SetFilePath(const class FString& Path);

	class USoundClass* GetSoundClass() const;
	const TArray<struct FSubtitleCue> GetSubtitles() const;
...
static_assert(sizeof(UFileMediaSource) == 0x0000D8, "Wrong size on UFileMediaSource");
...
static_assert(offsetof(UFileMediaSource, SoundClass) == 0x0000B0, "Member 'UFileMediaSource::SoundClass' has a wrong offset!");
static_assert(offsetof(UFileMediaSource, Volume) == 0x0000B8, "Member 'UFileMediaSource::Volume' has a wrong offset!");
static_assert(offsetof(UFileMediaSource, Subtitles) == 0x0000C0, "Member 'UFileMediaSource::Subtitles' has a wrong offset!");
static_assert(offsetof(UFileMediaSource, PlaceholderLength) == 0x0000D4, "Member 'UFileMediaSource::PlaceholderLength' has a wrong offset!");
...
{
public:
	class UMediaTexture*                          MediaTexture;                                      // 0x00B0(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, Transient, InstancedReference, NoDestructor, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UMediaPlayer*                           MediaPlayer;                                       // 0x00B8(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, Transient, InstancedReference, Interp, NoDestructor, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
