...
static_assert(offsetof(ChangeClientAsyncAction_ChangeClient, ClientId_0) == 0x000000, "Member 'ChangeClientAsyncAction_ChangeClient::ClientId_0' has a wrong offset!");
