...
TArray<class FName> UMovieSceneLevelVisibilitySection::GetAvailableLevelNames() const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("MovieSceneLevelVisibilitySection", "GetAvailableLevelNames");

	Params::MovieSceneLevelVisibilitySection_GetAvailableLevelNames Parms{};
