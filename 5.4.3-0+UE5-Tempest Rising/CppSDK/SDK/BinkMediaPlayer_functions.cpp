...
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// bool                                    bInMute                                                (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UBinkMediaPlayer::Mute(bool bInMute)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BinkMediaPlayer", "Mute");

	Params::BinkMediaPlayer_Mute Parms{};
