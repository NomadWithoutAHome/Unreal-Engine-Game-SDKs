...
// Function MediaAssets.FileMediaSource.GetSoundClass
// 0x0008 (0x0008 - 0x0000)
struct FileMediaSource_GetSoundClass final
{
public:
	class USoundClass*                            ReturnValue;                                       // 0x0000(0x0008)(Parm, OutParm, ZeroConstructor, ReturnParm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FileMediaSource_GetSoundClass) == 0x000008, "Wrong alignment on FileMediaSource_GetSoundClass");
static_assert(sizeof(FileMediaSource_GetSoundClass) == 0x000008, "Wrong size on FileMediaSource_GetSoundClass");
static_assert(offsetof(FileMediaSource_GetSoundClass, ReturnValue) == 0x000000, "Member 'FileMediaSource_GetSoundClass::ReturnValue' has a wrong offset!");

// Function MediaAssets.FileMediaSource.GetSubtitles
// 0x0010 (0x0010 - 0x0000)
struct FileMediaSource_GetSubtitles final
{
public:
	TArray<struct FSubtitleCue>                   ReturnValue;                                       // 0x0000(0x0010)(ConstParm, Parm, OutParm, ZeroConstructor, ReturnParm, ReferenceParm, NativeAccessSpecifierPublic)
};
static_assert(alignof(FileMediaSource_GetSubtitles) == 0x000008, "Wrong alignment on FileMediaSource_GetSubtitles");
static_assert(sizeof(FileMediaSource_GetSubtitles) == 0x000010, "Wrong size on FileMediaSource_GetSubtitles");
static_assert(offsetof(FileMediaSource_GetSubtitles, ReturnValue) == 0x000000, "Member 'FileMediaSource_GetSubtitles::ReturnValue' has a wrong offset!");

// Function MediaAssets.FileMediaSource.GetVolume
// 0x0004 (0x0004 - 0x0000)
struct FileMediaSource_GetVolume final
{
public:
	float                                         ReturnValue;                                       // 0x0000(0x0004)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FileMediaSource_GetVolume) == 0x000004, "Wrong alignment on FileMediaSource_GetVolume");
static_assert(sizeof(FileMediaSource_GetVolume) == 0x000004, "Wrong size on FileMediaSource_GetVolume");
static_assert(offsetof(FileMediaSource_GetVolume, ReturnValue) == 0x000000, "Member 'FileMediaSource_GetVolume::ReturnValue' has a wrong offset!");
