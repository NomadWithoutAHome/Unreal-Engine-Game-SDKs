...
{
public:
	class UNiagaraSystem*                         Asset;                                             // 0x0528(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	...
	uint8                                         bOverrideWarmupSettings : 1;                       // 0x0610(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
	uint8                                         Pad_611[0x3];                                      // 0x0611(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         WarmupTickCount;                                   // 0x0614(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                         WarmupTickDelta;                                   // 0x0618(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_61C[0x34];                                     // 0x061C(0x0034)(Fixing Size After Last Property [ Dumper-7 ])
	...
	ENiagaraOcclusionQueryMode                    OcclusionQueryMode;                                // 0x0659(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_65A[0x6];                                      // 0x065A(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	TMulticastInlineDelegate<void(class UNiagaraComponent* PSystem)> OnSystemFinished;               // 0x0660(0x0010)(ZeroConstructor, InstancedReference, DuplicateTransient, BlueprintAssignable, NativeAccessSpecifierPublic)
	...
	class FName                                   AutoAttachSocketName;                              // 0x0678(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EAttachmentRule                               AutoAttachLocationRule;                            // 0x0680(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EAttachmentRule                               AutoAttachRotationRule;                            // 0x0681(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EAttachmentRule                               AutoAttachScaleRule;                               // 0x0682(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_683[0x9];                                      // 0x0683(0x0009)(Fixing Size After Last Property [ Dumper-7 ])
	uint8                                         BitPad_68C_0 : 4;                                  // 0x068C(0x0001)(Fixing Bit-Field Size Between Bits [ Dumper-7 ])
	uint8                                         bAllowScalability : 1;                             // 0x068C(0x0001)(BitIndex: 0x04, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
	uint8                                         Pad_68D[0xEB];                                     // 0x068D(0x00EB)(Fixing Size After Last Property [ Dumper-7 ])
	class UNiagaraSimCache*                       SimCache;                                          // 0x0778(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UNiagaraCullProxyComponent*             CullProxy;                                         // 0x0780(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UNiagaraComponent) == 0x000790, "Wrong size on UNiagaraComponent");
...
static_assert(offsetof(UNiagaraComponent, RandomSeedOffset) == 0x000534, "Member 'UNiagaraComponent::RandomSeedOffset' has a wrong offset!");
...
static_assert(offsetof(UNiagaraComponent, WarmupTickCount) == 0x000614, "Member 'UNiagaraComponent::WarmupTickCount' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, WarmupTickDelta) == 0x000618, "Member 'UNiagaraComponent::WarmupTickDelta' has a wrong offset!");
...
static_assert(offsetof(UNiagaraComponent, OcclusionQueryMode) == 0x000659, "Member 'UNiagaraComponent::OcclusionQueryMode' has a wrong offset!");
...
static_assert(offsetof(UNiagaraComponent, AutoAttachLocationRule) == 0x000680, "Member 'UNiagaraComponent::AutoAttachLocationRule' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, AutoAttachRotationRule) == 0x000681, "Member 'UNiagaraComponent::AutoAttachRotationRule' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, AutoAttachScaleRule) == 0x000682, "Member 'UNiagaraComponent::AutoAttachScaleRule' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, SimCache) == 0x000778, "Member 'UNiagaraComponent::SimCache' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, CullProxy) == 0x000780, "Member 'UNiagaraComponent::CullProxy' has a wrong offset!");
...
{
public:
	TArray<struct FNiagaraCulledComponentInfo>    Instances;                                         // 0x0788(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UNiagaraCullProxyComponent) == 0x0007A0, "Wrong size on UNiagaraCullProxyComponent");
static_assert(offsetof(UNiagaraCullProxyComponent, Instances) == 0x000788, "Member 'UNiagaraCullProxyComponent::Instances' has a wrong offset!");
