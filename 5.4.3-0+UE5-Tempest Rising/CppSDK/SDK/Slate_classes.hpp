...
// Class Slate.SliderWidgetStyle
// 0x0500 (0x0530 - 0x0030)
class USliderWidgetStyle final : public USlateWidgetStyleContainerBase
{
public:
	struct FSliderStyle                           SliderStyle;                                       // 0x0030(0x0500)(Edit, NativeAccessSpecifierPublic)

public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"SliderWidgetStyle">();
	}
	static class USliderWidgetStyle* GetDefaultObj()
	{
		return GetDefaultObjImpl<USliderWidgetStyle>();
	}
};
static_assert(alignof(USliderWidgetStyle) == 0x000010, "Wrong alignment on USliderWidgetStyle");
static_assert(sizeof(USliderWidgetStyle) == 0x000530, "Wrong size on USliderWidgetStyle");
static_assert(offsetof(USliderWidgetStyle, SliderStyle) == 0x000030, "Member 'USliderWidgetStyle::SliderStyle' has a wrong offset!");
