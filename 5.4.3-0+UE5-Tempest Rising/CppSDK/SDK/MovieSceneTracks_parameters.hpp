...
// Function MovieSceneTracks.MovieSceneLevelVisibilitySection.GetAvailableLevelNames
// 0x0010 (0x0010 - 0x0000)
struct MovieSceneLevelVisibilitySection_GetAvailableLevelNames final
{
public:
	TArray<class FName>                           ReturnValue;                                       // 0x0000(0x0010)(Parm, OutParm, ZeroConstructor, ReturnParm, NativeAccessSpecifierPublic)
};
static_assert(alignof(MovieSceneLevelVisibilitySection_GetAvailableLevelNames) == 0x000008, "Wrong alignment on MovieSceneLevelVisibilitySection_GetAvailableLevelNames");
static_assert(sizeof(MovieSceneLevelVisibilitySection_GetAvailableLevelNames) == 0x000010, "Wrong size on MovieSceneLevelVisibilitySection_GetAvailableLevelNames");
static_assert(offsetof(MovieSceneLevelVisibilitySection_GetAvailableLevelNames, ReturnValue) == 0x000000, "Member 'MovieSceneLevelVisibilitySection_GetAvailableLevelNames::ReturnValue' has a wrong offset!");
