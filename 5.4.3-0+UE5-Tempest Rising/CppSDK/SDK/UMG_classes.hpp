...
public:
	...
	class USlateWidgetStyleAsset*                 StyleAsset;                                        // 0x0178(0x0008)(Edit, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
public:
	...
	void SetStyleAsset(class USlateWidgetStyleAsset* InAsset);
	...
	class USlateWidgetStyleAsset* GetStyleAsset() const;
...
static_assert(offsetof(UWidget, StyleAsset) == 0x000178, "Member 'UWidget::StyleAsset' has a wrong offset!");

// Class UMG.UserWidget
// 0x0168 (0x02E8 - 0x0180)
...
public:
	...
	struct FMargin                                Padding;                                           // 0x0210(0x0010)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	int32                                         Priority;                                          // 0x0220(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         bIsFocusable : 1;                                  // 0x0224(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bStopAction : 1;                                   // 0x0224(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_225[0x3];                                      // 0x0225(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FQueuedWidgetAnimationTransition> QueuedWidgetAnimationTransitions;                // 0x0228(0x0010)(ZeroConstructor, Transient, NativeAccessSpecifierPublic)
	TArray<class UUMGSequencePlayer*>             ActiveSequencePlayers;                             // 0x0238(0x0010)(ZeroConstructor, Transient, UObjectWrapper, NativeAccessSpecifierPublic)
	class UUMGSequenceTickManager*                AnimationTickManager;                              // 0x0248(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<class UUMGSequencePlayer*>             StoppedSequencePlayers;                            // 0x0250(0x0010)(ZeroConstructor, Transient, UObjectWrapper, NativeAccessSpecifierPublic)
	...
	TArray<class UUserWidgetExtension*>           Extensions;                                        // 0x0270(0x0010)(ExportObject, ZeroConstructor, ContainsInstancedReference, UObjectWrapper, NativeAccessSpecifierPrivate)
	class UWidgetTree*                            WidgetTree;                                        // 0x0280(0x0008)(ZeroConstructor, Transient, DuplicateTransient, NoDestructor, TextExportTransient, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         bHasScriptImplementedTick : 1;                     // 0x0288(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bHasScriptImplementedPaint : 1;                    // 0x0288(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_289[0x17];                                     // 0x0289(0x0017)(Fixing Size After Last Property [ Dumper-7 ])
	EWidgetTickFrequency                          TickFrequency;                                     // 0x02A0(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_2A1[0x3];                                      // 0x02A1(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FWidgetChild                           DesiredFocusWidget;                                // 0x02A4(0x0010)(Edit, DisableEditOnInstance, NoDestructor, ContainsInstancedReference, NativeAccessSpecifierPrivate)
	uint8                                         Pad_2B4[0x4];                                      // 0x02B4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UInputComponent*                        InputComponent;                                    // 0x02B8(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, DuplicateTransient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TArray<struct FAnimationEventBinding>         AnimationCallbacks;                                // 0x02C0(0x0010)(ZeroConstructor, Transient, DuplicateTransient, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UUserWidget) == 0x0002E8, "Wrong size on UUserWidget");
...
static_assert(offsetof(UUserWidget, Padding) == 0x000210, "Member 'UUserWidget::Padding' has a wrong offset!");
static_assert(offsetof(UUserWidget, Priority) == 0x000220, "Member 'UUserWidget::Priority' has a wrong offset!");
static_assert(offsetof(UUserWidget, QueuedWidgetAnimationTransitions) == 0x000228, "Member 'UUserWidget::QueuedWidgetAnimationTransitions' has a wrong offset!");
...
static_assert(offsetof(UUserWidget, Extensions) == 0x000270, "Member 'UUserWidget::Extensions' has a wrong offset!");
static_assert(offsetof(UUserWidget, WidgetTree) == 0x000280, "Member 'UUserWidget::WidgetTree' has a wrong offset!");
static_assert(offsetof(UUserWidget, TickFrequency) == 0x0002A0, "Member 'UUserWidget::TickFrequency' has a wrong offset!");
static_assert(offsetof(UUserWidget, DesiredFocusWidget) == 0x0002A4, "Member 'UUserWidget::DesiredFocusWidget' has a wrong offset!");
static_assert(offsetof(UUserWidget, InputComponent) == 0x0002B8, "Member 'UUserWidget::InputComponent' has a wrong offset!");
static_assert(offsetof(UUserWidget, AnimationCallbacks) == 0x0002C0, "Member 'UUserWidget::AnimationCallbacks' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_294[0x44];                                     // 0x0294(0x0044)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(UWidgetInteractionComponent, OnHoveredWidgetChanged) == 0x000240, "Member 'UWidgetInteractionComponent::OnHoveredWidgetChanged' has a wrong offset!");
static_assert(offsetof(UWidgetInteractionComponent, VirtualUserIndex) == 0x000260, "Member 'UWidgetInteractionComponent::VirtualUserIndex' has a wrong offset!");
static_assert(offsetof(UWidgetInteractionComponent, PointerIndex) == 0x000264, "Member 'UWidgetInteractionComponent::PointerIndex' has a wrong offset!");
static_assert(offsetof(UWidgetInteractionComponent, TraceChannel) == 0x000268, "Member 'UWidgetInteractionComponent::TraceChannel' has a wrong offset!");
static_assert(offsetof(UWidgetInteractionComponent, InteractionDistance) == 0x00026C, "Member 'UWidgetInteractionComponent::InteractionDistance' has a wrong offset!");
static_assert(offsetof(UWidgetInteractionComponent, InteractionSource) == 0x000270, "Member 'UWidgetInteractionComponent::InteractionSource' has a wrong offset!");
static_assert(offsetof(UWidgetInteractionComponent, bEnableHitTesting) == 0x000271, "Member 'UWidgetInteractionComponent::bEnableHitTesting' has a wrong offset!");
static_assert(offsetof(UWidgetInteractionComponent, bShowDebug) == 0x000272, "Member 'UWidgetInteractionComponent::bShowDebug' has a wrong offset!");
static_assert(offsetof(UWidgetInteractionComponent, DebugSphereLineThickness) == 0x000274, "Member 'UWidgetInteractionComponent::DebugSphereLineThickness' has a wrong offset!");
static_assert(offsetof(UWidgetInteractionComponent, DebugLineThickness) == 0x000278, "Member 'UWidgetInteractionComponent::DebugLineThickness' has a wrong offset!");
...
static_assert(offsetof(UWidgetInteractionComponent, LocalHitLocation) == 0x000400, "Member 'UWidgetInteractionComponent::LocalHitLocation' has a wrong offset!");
static_assert(offsetof(UWidgetInteractionComponent, LastLocalHitLocation) == 0x000410, "Member 'UWidgetInteractionComponent::LastLocalHitLocation' has a wrong offset!");
static_assert(offsetof(UWidgetInteractionComponent, HoveredWidgetComponent) == 0x000420, "Member 'UWidgetInteractionComponent::HoveredWidgetComponent' has a wrong offset!");
static_assert(offsetof(UWidgetInteractionComponent, LastHitResult) == 0x000428, "Member 'UWidgetInteractionComponent::LastHitResult' has a wrong offset!");
