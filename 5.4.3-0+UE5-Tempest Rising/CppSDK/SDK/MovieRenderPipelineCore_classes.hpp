...
static_assert(sizeof(UMovieGraphBurnInWidget) == 0x0002E8, "Wrong size on UMovieGraphBurnInWidget");
...
static_assert(sizeof(UMovieRenderDebugWidget) == 0x0002E8, "Wrong size on UMovieRenderDebugWidget");
...
static_assert(sizeof(UMovieGraphRenderPreviewWidget) == 0x0002E8, "Wrong size on UMovieGraphRenderPreviewWidget");
