...
// (Final, Native, Public, BlueprintCallable, BlueprintPure, Const)
// Parameters:
// class USoundClass*                      ReturnValue                                            (Parm, OutParm, ZeroConstructor, ReturnParm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

class USoundClass* UFileMediaSource::GetSoundClass() const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("FileMediaSource", "GetSoundClass");

	Params::FileMediaSource_GetSoundClass Parms{};
...
// (Final, Native, Public, BlueprintCallable, BlueprintPure, Const)
// Parameters:
// const TArray<struct FSubtitleCue>       ReturnValue                                            (ConstParm, Parm, OutParm, ZeroConstructor, ReturnParm, ReferenceParm, NativeAccessSpecifierPublic)

const TArray<struct FSubtitleCue> UFileMediaSource::GetSubtitles() const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("FileMediaSource", "GetSubtitles");

	Params::FileMediaSource_GetSubtitles Parms{};
...
float UFileMediaSource::GetVolume() const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("FileMediaSource", "GetVolume");

	Params::FileMediaSource_GetVolume Parms{};
