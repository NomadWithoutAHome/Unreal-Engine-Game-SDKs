...
// Function UMG.Widget.SetStyleAsset
// 0x0008 (0x0008 - 0x0000)
struct Widget_SetStyleAsset final
{
public:
...
static_assert(alignof(Widget_SetStyleAsset) == 0x000008, "Wrong alignment on Widget_SetStyleAsset");
static_assert(sizeof(Widget_SetStyleAsset) == 0x000008, "Wrong size on Widget_SetStyleAsset");
static_assert(offsetof(Widget_SetStyleAsset, InAsset) == 0x000000, "Member 'Widget_SetStyleAsset::InAsset' has a wrong offset!");
...
// Function UMG.Widget.GetStyleAsset
// 0x0008 (0x0008 - 0x0000)
struct Widget_GetStyleAsset final
{
public:
	class USlateWidgetStyleAsset*                 ReturnValue;                                       // 0x0000(0x0008)(Parm, OutParm, ZeroConstructor, ReturnParm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(Widget_GetStyleAsset) == 0x000008, "Wrong alignment on Widget_GetStyleAsset");
static_assert(sizeof(Widget_GetStyleAsset) == 0x000008, "Wrong size on Widget_GetStyleAsset");
static_assert(offsetof(Widget_GetStyleAsset, ReturnValue) == 0x000000, "Member 'Widget_GetStyleAsset::ReturnValue' has a wrong offset!");
...
// Function UMG.UserWidget.OnSetStyleAsset
// 0x0008 (0x0008 - 0x0000)
struct UserWidget_OnSetStyleAsset final
{
public:
	class USlateWidgetStyleAsset*                 InAsset;                                           // 0x0000(0x0008)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(UserWidget_OnSetStyleAsset) == 0x000008, "Wrong alignment on UserWidget_OnSetStyleAsset");
static_assert(sizeof(UserWidget_OnSetStyleAsset) == 0x000008, "Wrong size on UserWidget_OnSetStyleAsset");
static_assert(offsetof(UserWidget_OnSetStyleAsset, InAsset) == 0x000000, "Member 'UserWidget_OnSetStyleAsset::InAsset' has a wrong offset!");
