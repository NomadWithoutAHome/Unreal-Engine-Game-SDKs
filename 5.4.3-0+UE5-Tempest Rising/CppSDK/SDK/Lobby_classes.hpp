...
{
public:
	class ALobbyBeaconState*                      LobbyState;                                        // 0x0320(0x0008)(Net, ZeroConstructor, RepNotify, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	class FString                                 LocalPassword;                                     // 0x0330(0x0010)(ZeroConstructor, Transient, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                         Pad_342[0x76];                                     // 0x0342(0x0076)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(ALobbyBeaconClient, LocalPassword) == 0x000330, "Member 'ALobbyBeaconClient::LocalPassword' has a wrong offset!");
