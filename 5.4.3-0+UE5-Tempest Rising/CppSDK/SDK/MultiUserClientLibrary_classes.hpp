...
static_assert(alignof(IMultiUserReplicationRegistration) == 0x000001, "Wrong alignment on IMultiUserReplicationRegistration");
static_assert(sizeof(IMultiUserReplicationRegistration) == 0x000001, "Wrong size on IMultiUserReplicationRegistration");
...
static_assert(alignof(IMultiUserReplicationRegistrationContext) == 0x000001, "Wrong alignment on IMultiUserReplicationRegistrationContext");
static_assert(sizeof(IMultiUserReplicationRegistrationContext) == 0x000001, "Wrong size on IMultiUserReplicationRegistrationContext");
