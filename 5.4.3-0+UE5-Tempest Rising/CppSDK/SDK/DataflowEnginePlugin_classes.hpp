...
{
public:
	uint8                                         Pad_528[0x148];                                    // 0x0528(0x0148)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UDataflowComponent) == 0x000670, "Wrong size on UDataflowComponent");
