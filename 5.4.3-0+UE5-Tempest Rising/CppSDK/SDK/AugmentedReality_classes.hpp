...
public:
	...
	class UMaterialInterface*                     DefaultMeshMaterial;                               // 0x0288(0x0008)(Edit, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UMaterialInterface*                     DefaultWireframeMeshMaterial;                      // 0x0290(0x0008)(Edit, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UMRMeshComponent*                       MRMeshComponent;                                   // 0x0298(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UARTrackedGeometry*                     MyTrackedGeometry;                                 // 0x02A0(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UARComponent) == 0x0002C0, "Wrong size on UARComponent");
static_assert(offsetof(UARComponent, NativeID) == 0x000240, "Member 'UARComponent::NativeID' has a wrong offset!");
static_assert(offsetof(UARComponent, bUseDefaultReplication) == 0x000280, "Member 'UARComponent::bUseDefaultReplication' has a wrong offset!");
static_assert(offsetof(UARComponent, DefaultMeshMaterial) == 0x000288, "Member 'UARComponent::DefaultMeshMaterial' has a wrong offset!");
static_assert(offsetof(UARComponent, DefaultWireframeMeshMaterial) == 0x000290, "Member 'UARComponent::DefaultWireframeMeshMaterial' has a wrong offset!");
static_assert(offsetof(UARComponent, MRMeshComponent) == 0x000298, "Member 'UARComponent::MRMeshComponent' has a wrong offset!");
static_assert(offsetof(UARComponent, MyTrackedGeometry) == 0x0002A0, "Member 'UARComponent::MyTrackedGeometry' has a wrong offset!");
...
static_assert(sizeof(UARPlaneComponent) == 0x000390, "Wrong size on UARPlaneComponent");
static_assert(offsetof(UARPlaneComponent, ReplicatedPayload) == 0x0002C0, "Member 'UARPlaneComponent::ReplicatedPayload' has a wrong offset!");
...
static_assert(sizeof(UARPointComponent) == 0x0002D0, "Wrong size on UARPointComponent");
static_assert(offsetof(UARPointComponent, ReplicatedPayload) == 0x0002C0, "Member 'UARPointComponent::ReplicatedPayload' has a wrong offset!");
...
static_assert(sizeof(UARFaceComponent) == 0x000350, "Wrong size on UARFaceComponent");
static_assert(offsetof(UARFaceComponent, TransformSetting) == 0x0002C0, "Member 'UARFaceComponent::TransformSetting' has a wrong offset!");
static_assert(offsetof(UARFaceComponent, bUpdateVertexNormal) == 0x0002C1, "Member 'UARFaceComponent::bUpdateVertexNormal' has a wrong offset!");
static_assert(offsetof(UARFaceComponent, bFaceOutOfScreen) == 0x0002C2, "Member 'UARFaceComponent::bFaceOutOfScreen' has a wrong offset!");
static_assert(offsetof(UARFaceComponent, ReplicatedPayload) == 0x0002C8, "Member 'UARFaceComponent::ReplicatedPayload' has a wrong offset!");
...
static_assert(sizeof(UARImageComponent) == 0x000360, "Wrong size on UARImageComponent");
static_assert(offsetof(UARImageComponent, ReplicatedPayload) == 0x0002C0, "Member 'UARImageComponent::ReplicatedPayload' has a wrong offset!");
...
static_assert(sizeof(UARQRCodeComponent) == 0x000370, "Wrong size on UARQRCodeComponent");
static_assert(offsetof(UARQRCodeComponent, ReplicatedPayload) == 0x0002C0, "Member 'UARQRCodeComponent::ReplicatedPayload' has a wrong offset!");
...
static_assert(sizeof(UARPoseComponent) == 0x000330, "Wrong size on UARPoseComponent");
static_assert(offsetof(UARPoseComponent, ReplicatedPayload) == 0x0002C0, "Member 'UARPoseComponent::ReplicatedPayload' has a wrong offset!");
...
static_assert(sizeof(UAREnvironmentProbeComponent) == 0x000320, "Wrong size on UAREnvironmentProbeComponent");
static_assert(offsetof(UAREnvironmentProbeComponent, ReplicatedPayload) == 0x0002C0, "Member 'UAREnvironmentProbeComponent::ReplicatedPayload' has a wrong offset!");
...
static_assert(sizeof(UARObjectComponent) == 0x000320, "Wrong size on UARObjectComponent");
static_assert(offsetof(UARObjectComponent, ReplicatedPayload) == 0x0002C0, "Member 'UARObjectComponent::ReplicatedPayload' has a wrong offset!");
...
static_assert(sizeof(UARMeshComponent) == 0x000350, "Wrong size on UARMeshComponent");
static_assert(offsetof(UARMeshComponent, ReplicatedPayload) == 0x0002C0, "Member 'UARMeshComponent::ReplicatedPayload' has a wrong offset!");
...
static_assert(sizeof(UARGeoAnchorComponent) == 0x000360, "Wrong size on UARGeoAnchorComponent");
static_assert(offsetof(UARGeoAnchorComponent, ReplicatedPayload) == 0x0002C0, "Member 'UARGeoAnchorComponent::ReplicatedPayload' has a wrong offset!");
...
static_assert(sizeof(UARLifeCycleComponent) == 0x000270, "Wrong size on UARLifeCycleComponent");
static_assert(offsetof(UARLifeCycleComponent, OnARActorSpawnedDelegate) == 0x000240, "Member 'UARLifeCycleComponent::OnARActorSpawnedDelegate' has a wrong offset!");
static_assert(offsetof(UARLifeCycleComponent, OnARActorToBeDestroyedDelegate) == 0x000250, "Member 'UARLifeCycleComponent::OnARActorToBeDestroyedDelegate' has a wrong offset!");
