...
static_assert(offsetof(ULiveLinkComponentController, OnControllerMapUpdatedDelegate) == 0x000128, "Member 'ULiveLinkComponentController::OnControllerMapUpdatedDelegate' has a wrong offset!");
static_assert(offsetof(ULiveLinkComponentController, bDisableEvaluateLiveLinkWhenSpawnable) == 0x000138, "Member 'ULiveLinkComponentController::bDisableEvaluateLiveLinkWhenSpawnable' has a wrong offset!");
static_assert(offsetof(ULiveLinkComponentController, bEvaluateLiveLink) == 0x000139, "Member 'ULiveLinkComponentController::bEvaluateLiveLink' has a wrong offset!");
static_assert(offsetof(ULiveLinkComponentController, bUpdateInPreviewEditor) == 0x00013A, "Member 'ULiveLinkComponentController::bUpdateInPreviewEditor' has a wrong offset!");
