...
public:
	...
	class FName                                   MotionSource;                                      // 0x052C(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	ETrackingStatus                               CurrentTrackingStatus;                             // 0x0538(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_539[0x137];                                    // 0x0539(0x0137)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UMotionControllerComponent) == 0x000670, "Wrong size on UMotionControllerComponent");
...
static_assert(offsetof(UMotionControllerComponent, MotionSource) == 0x00052C, "Member 'UMotionControllerComponent::MotionSource' has a wrong offset!");
static_assert(offsetof(UMotionControllerComponent, CurrentTrackingStatus) == 0x000538, "Member 'UMotionControllerComponent::CurrentTrackingStatus' has a wrong offset!");
