...
// Function BinkMediaPlayer.BinkMediaPlayer.Mute
// 0x0001 (0x0001 - 0x0000)
struct BinkMediaPlayer_Mute final
{
public:
	bool                                          bInMute;                                           // 0x0000(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(BinkMediaPlayer_Mute) == 0x000001, "Wrong alignment on BinkMediaPlayer_Mute");
static_assert(sizeof(BinkMediaPlayer_Mute) == 0x000001, "Wrong size on BinkMediaPlayer_Mute");
static_assert(offsetof(BinkMediaPlayer_Mute, bInMute) == 0x000000, "Member 'BinkMediaPlayer_Mute::bInMute' has a wrong offset!");
