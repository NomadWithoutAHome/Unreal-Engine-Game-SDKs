...
// const TDelegate<void(class UVaRestRequestJSON* Request)>&Callback                                               (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)
