...
namespace Offsets
{
	constexpr int32 GObjects          = 0x04B19B50;
	constexpr int32 AppendString      = 0x010B9180;
	constexpr int32 GNames            = 0x04ADD800;
	constexpr int32 GWorld            = 0x04C614D0;
	constexpr int32 ProcessEvent      = 0x012A90F0;
