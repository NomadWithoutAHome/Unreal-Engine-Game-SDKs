...
// Function CommonUI.CommonActivatableWidget.GetVirtualTreeParent
// 0x0008 (0x0008 - 0x0000)
struct CommonActivatableWidget_GetVirtualTreeParent final
{
public:
	class UCommonActivatableWidget*               ReturnValue;                                       // 0x0000(0x0008)(ExportObject, Parm, OutParm, ZeroConstructor, ReturnParm, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(CommonActivatableWidget_GetVirtualTreeParent) == 0x000008, "Wrong alignment on CommonActivatableWidget_GetVirtualTreeParent");
...
static_assert(offsetof(CommonActivatableWidget_GetVirtualTreeParent, ReturnValue) == 0x000000, "Member 'CommonActivatableWidget_GetVirtualTreeParent::ReturnValue' has a wrong offset!");
...
// Function CommonUI.CommonVideoPlayer.GetInternalMediaPlayer
// 0x0008 (0x0008 - 0x0000)
struct CommonVideoPlayer_GetInternalMediaPlayer final
{
public:
...
static_assert(alignof(CommonVideoPlayer_GetInternalMediaPlayer) == 0x000008, "Wrong alignment on CommonVideoPlayer_GetInternalMediaPlayer");
...
static_assert(offsetof(CommonVideoPlayer_GetInternalMediaPlayer, ReturnValue) == 0x000000, "Member 'CommonVideoPlayer_GetInternalMediaPlayer::ReturnValue' has a wrong offset!");
...
// Function CommonUI.CommonBoundActionButton.OnActionTextUpdate
// 0x0010 (0x0010 - 0x0000)
struct CommonBoundActionButton_OnActionTextUpdate final
{
public:
	class FText                                   InActionText;                                      // 0x0000(0x0010)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
};
static_assert(alignof(CommonBoundActionButton_OnActionTextUpdate) == 0x000008, "Wrong alignment on CommonBoundActionButton_OnActionTextUpdate");
static_assert(sizeof(CommonBoundActionButton_OnActionTextUpdate) == 0x000010, "Wrong size on CommonBoundActionButton_OnActionTextUpdate");
static_assert(offsetof(CommonBoundActionButton_OnActionTextUpdate, InActionText) == 0x000000, "Member 'CommonBoundActionButton_OnActionTextUpdate::InActionText' has a wrong offset!");
