...
// Function EnhancedInput.EnhancedInputUserSettings.SetSettingsSaveSlotName
// 0x0010 (0x0010 - 0x0000)
struct EnhancedInputUserSettings_SetSettingsSaveSlotName final
{
public:
	class FString                                 SettingsSaveSlotName;                              // 0x0000(0x0010)(Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(EnhancedInputUserSettings_SetSettingsSaveSlotName) == 0x000008, "Wrong alignment on EnhancedInputUserSettings_SetSettingsSaveSlotName");
static_assert(sizeof(EnhancedInputUserSettings_SetSettingsSaveSlotName) == 0x000010, "Wrong size on EnhancedInputUserSettings_SetSettingsSaveSlotName");
static_assert(offsetof(EnhancedInputUserSettings_SetSettingsSaveSlotName, SettingsSaveSlotName) == 0x000000, "Member 'EnhancedInputUserSettings_SetSettingsSaveSlotName::SettingsSaveSlotName' has a wrong offset!");
