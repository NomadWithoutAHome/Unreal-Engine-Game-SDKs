...
{
public:
	struct FSlateColor                            MinBarColor;                                       // 0x0028(0x0014)(Edit, Config, NativeAccessSpecifierPublic)
	struct FSlateColor                            MaxBarColor;                                       // 0x003C(0x0014)(Edit, Config, NativeAccessSpecifierPublic)
	float                                         DPIScaleMultiplier;                                // 0x0050(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(ULiveLinkDebuggerSettings) == 0x000058, "Wrong size on ULiveLinkDebuggerSettings");
...
static_assert(offsetof(ULiveLinkDebuggerSettings, MaxBarColor) == 0x00003C, "Member 'ULiveLinkDebuggerSettings::MaxBarColor' has a wrong offset!");
static_assert(offsetof(ULiveLinkDebuggerSettings, DPIScaleMultiplier) == 0x000050, "Member 'ULiveLinkDebuggerSettings::DPIScaleMultiplier' has a wrong offset!");
