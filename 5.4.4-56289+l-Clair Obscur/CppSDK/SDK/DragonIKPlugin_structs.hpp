...
public:
	...
	uint8                                         Pad_498[0x258];                                    // 0x0498(0x0258)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FAnimNode_DragonWarpSolver) == 0x000010, "Wrong alignment on FAnimNode_DragonWarpSolver");
static_assert(sizeof(FAnimNode_DragonWarpSolver) == 0x0006F0, "Wrong size on FAnimNode_DragonWarpSolver");
...
public:
	...
	struct FHitResult                             hit_result;                                        // 0x0010(0x00F8)(Edit, BlueprintVisible, BlueprintReadOnly, IsPlainOldData, NoDestructor, ContainsInstancedReference, NativeAccessSpecifierPublic)
};
static_assert(alignof(FDragonIKTraceKeyValuePair) == 0x000008, "Wrong alignment on FDragonIKTraceKeyValuePair");
static_assert(sizeof(FDragonIKTraceKeyValuePair) == 0x000108, "Wrong size on FDragonIKTraceKeyValuePair");
...
public:
	...
	struct FDragonData_ChineseDragonBoneInput     Custom_Bone_Input;                                 // 0x0100(0x0010)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	int32                                         Stability_Reference_Bone_Index;                    // 0x0110(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_114[0xC];                                      // 0x0114(0x000C)(Fixing Size After Last Property [ Dumper-7 ])
	struct FTransform                             EffectorTransform;                                 // 0x0120(0x0060)(Edit, BlueprintVisible, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FDragonData_ChineseDragonBoneRotationOffset Extra_Rotation_Offset_Per_Bone;               // 0x0180(0x0010)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FRotator                               Extra_Rotation_Offset_Overall;                     // 0x0190(0x0018)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	struct FRotator                               Extra_Rotation_Offset;                             // 0x01A8(0x0018)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_1C0[0xC0];                                     // 0x01C0(0x00C0)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          Use_Advanced_Strict_Chain_Logic;                   // 0x0280(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_281[0x7];                                      // 0x0281(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          Limit_Z_Solving;                                   // 0x0288(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          Fix_Root_in_Place;                                 // 0x0289(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          Continous_Normalization;                           // 0x028A(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_28B[0x1];                                      // 0x028B(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         Normalization_Speed;                               // 0x028C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FRuntimeFloatCurve                     Normalization_Multiplier_Rel_Velocity;             // 0x0290(0x0088)(Edit, NativeAccessSpecifierPublic)
	bool                                          Preserve_Original_Pose;                            // 0x0318(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_319[0x7];                                      // 0x0319(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVector                                Test_Ref_Forward_Axis;                             // 0x0320(0x0018)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         Pelvis_Positioning_Calibration_Value;              // 0x0338(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_33C[0x24];                                     // 0x033C(0x0024)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          Enable_AnimBP_Viewport_Output;                     // 0x0360(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          Use_Scale_Add_Mode;                                // 0x0361(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          Use_Rot_Add_Mode;                                  // 0x0362(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          rotation_relative_to_mesh;                         // 0x0363(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          Use_Warmup_Logic;                                  // 0x0364(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_365[0x3];                                      // 0x0365(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         Initial_Warmup_Distance;                           // 0x0368(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          Reset_To_Normal;                                   // 0x036C(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_36D[0xF];                                      // 0x036D(0x000F)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          Use_Interpolation;                                 // 0x037C(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_37D[0x3];                                      // 0x037D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         Interpolation_Speed;                               // 0x0380(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         Reset_ON_Interpolation_Speed;                      // 0x0384(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         Reset_OFF_Interpolation_Speed;                     // 0x0388(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         Precision;                                         // 0x038C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_390[0x10];                                     // 0x0390(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	struct FTransform                             CachedEffectorCSTransform;                         // 0x03A0(0x0060)(Edit, BlueprintVisible, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FAnimNode_ChineseDragonSolver) == 0x0004B0, "Wrong size on FAnimNode_ChineseDragonSolver");
static_assert(offsetof(FAnimNode_ChineseDragonSolver, Custom_Bone_Input) == 0x000100, "Member 'FAnimNode_ChineseDragonSolver::Custom_Bone_Input' has a wrong offset!");
static_assert(offsetof(FAnimNode_ChineseDragonSolver, Stability_Reference_Bone_Index) == 0x000110, "Member 'FAnimNode_ChineseDragonSolver::Stability_Reference_Bone_Index' has a wrong offset!");
static_assert(offsetof(FAnimNode_ChineseDragonSolver, EffectorTransform) == 0x000120, "Member 'FAnimNode_ChineseDragonSolver::EffectorTransform' has a wrong offset!");
static_assert(offsetof(FAnimNode_ChineseDragonSolver, Extra_Rotation_Offset_Per_Bone) == 0x000180, "Member 'FAnimNode_ChineseDragonSolver::Extra_Rotation_Offset_Per_Bone' has a wrong offset!");
static_assert(offsetof(FAnimNode_ChineseDragonSolver, Extra_Rotation_Offset_Overall) == 0x000190, "Member 'FAnimNode_ChineseDragonSolver::Extra_Rotation_Offset_Overall' has a wrong offset!");
static_assert(offsetof(FAnimNode_ChineseDragonSolver, Extra_Rotation_Offset) == 0x0001A8, "Member 'FAnimNode_ChineseDragonSolver::Extra_Rotation_Offset' has a wrong offset!");
static_assert(offsetof(FAnimNode_ChineseDragonSolver, Use_Advanced_Strict_Chain_Logic) == 0x000280, "Member 'FAnimNode_ChineseDragonSolver::Use_Advanced_Strict_Chain_Logic' has a wrong offset!");
static_assert(offsetof(FAnimNode_ChineseDragonSolver, Limit_Z_Solving) == 0x000288, "Member 'FAnimNode_ChineseDragonSolver::Limit_Z_Solving' has a wrong offset!");
static_assert(offsetof(FAnimNode_ChineseDragonSolver, Fix_Root_in_Place) == 0x000289, "Member 'FAnimNode_ChineseDragonSolver::Fix_Root_in_Place' has a wrong offset!");
static_assert(offsetof(FAnimNode_ChineseDragonSolver, Continous_Normalization) == 0x00028A, "Member 'FAnimNode_ChineseDragonSolver::Continous_Normalization' has a wrong offset!");
static_assert(offsetof(FAnimNode_ChineseDragonSolver, Normalization_Speed) == 0x00028C, "Member 'FAnimNode_ChineseDragonSolver::Normalization_Speed' has a wrong offset!");
static_assert(offsetof(FAnimNode_ChineseDragonSolver, Normalization_Multiplier_Rel_Velocity) == 0x000290, "Member 'FAnimNode_ChineseDragonSolver::Normalization_Multiplier_Rel_Velocity' has a wrong offset!");
static_assert(offsetof(FAnimNode_ChineseDragonSolver, Preserve_Original_Pose) == 0x000318, "Member 'FAnimNode_ChineseDragonSolver::Preserve_Original_Pose' has a wrong offset!");
static_assert(offsetof(FAnimNode_ChineseDragonSolver, Test_Ref_Forward_Axis) == 0x000320, "Member 'FAnimNode_ChineseDragonSolver::Test_Ref_Forward_Axis' has a wrong offset!");
static_assert(offsetof(FAnimNode_ChineseDragonSolver, Pelvis_Positioning_Calibration_Value) == 0x000338, "Member 'FAnimNode_ChineseDragonSolver::Pelvis_Positioning_Calibration_Value' has a wrong offset!");
static_assert(offsetof(FAnimNode_ChineseDragonSolver, Enable_AnimBP_Viewport_Output) == 0x000360, "Member 'FAnimNode_ChineseDragonSolver::Enable_AnimBP_Viewport_Output' has a wrong offset!");
static_assert(offsetof(FAnimNode_ChineseDragonSolver, Use_Scale_Add_Mode) == 0x000361, "Member 'FAnimNode_ChineseDragonSolver::Use_Scale_Add_Mode' has a wrong offset!");
static_assert(offsetof(FAnimNode_ChineseDragonSolver, Use_Rot_Add_Mode) == 0x000362, "Member 'FAnimNode_ChineseDragonSolver::Use_Rot_Add_Mode' has a wrong offset!");
static_assert(offsetof(FAnimNode_ChineseDragonSolver, rotation_relative_to_mesh) == 0x000363, "Member 'FAnimNode_ChineseDragonSolver::rotation_relative_to_mesh' has a wrong offset!");
static_assert(offsetof(FAnimNode_ChineseDragonSolver, Use_Warmup_Logic) == 0x000364, "Member 'FAnimNode_ChineseDragonSolver::Use_Warmup_Logic' has a wrong offset!");
static_assert(offsetof(FAnimNode_ChineseDragonSolver, Initial_Warmup_Distance) == 0x000368, "Member 'FAnimNode_ChineseDragonSolver::Initial_Warmup_Distance' has a wrong offset!");
static_assert(offsetof(FAnimNode_ChineseDragonSolver, Reset_To_Normal) == 0x00036C, "Member 'FAnimNode_ChineseDragonSolver::Reset_To_Normal' has a wrong offset!");
static_assert(offsetof(FAnimNode_ChineseDragonSolver, Use_Interpolation) == 0x00037C, "Member 'FAnimNode_ChineseDragonSolver::Use_Interpolation' has a wrong offset!");
static_assert(offsetof(FAnimNode_ChineseDragonSolver, Interpolation_Speed) == 0x000380, "Member 'FAnimNode_ChineseDragonSolver::Interpolation_Speed' has a wrong offset!");
static_assert(offsetof(FAnimNode_ChineseDragonSolver, Reset_ON_Interpolation_Speed) == 0x000384, "Member 'FAnimNode_ChineseDragonSolver::Reset_ON_Interpolation_Speed' has a wrong offset!");
static_assert(offsetof(FAnimNode_ChineseDragonSolver, Reset_OFF_Interpolation_Speed) == 0x000388, "Member 'FAnimNode_ChineseDragonSolver::Reset_OFF_Interpolation_Speed' has a wrong offset!");
static_assert(offsetof(FAnimNode_ChineseDragonSolver, Precision) == 0x00038C, "Member 'FAnimNode_ChineseDragonSolver::Precision' has a wrong offset!");
static_assert(offsetof(FAnimNode_ChineseDragonSolver, CachedEffectorCSTransform) == 0x0003A0, "Member 'FAnimNode_ChineseDragonSolver::CachedEffectorCSTransform' has a wrong offset!");
...
public:
	...
	struct FDragonData_MultiInput                 dragon_input_data;                                 // 0x0188(0x0020)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	uint8                                         Pad_1A8[0xA8];                                     // 0x01A8(0x00A8)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FDragonData_ArmsData>           Aiming_Hand_Limbs;                                 // 0x0250(0x0010)(Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_260[0x10];                                     // 0x0260(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	struct FDragonData_Overrided_Location_Data    Arm_TargetLocation_Overrides;                      // 0x0270(0x0010)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	bool                                          Use_Separate_Targets;                              // 0x0280(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          Override_Hand_Rotation;                            // 0x0281(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          enable_head_aim;                                   // 0x0282(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bAllowHandStretching;                              // 0x0283(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_284[0x4];                                      // 0x0284(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FDragonData_ElbowOffset_Struct         Extra_Struct_Elbow_Pole_Array;                     // 0x0288(0x0010)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	bool                                          reach_instead;                                     // 0x0298(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          Aggregate_Hand_Body;                               // 0x0299(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          Let_Arm_Twist_With_Hand;                           // 0x029A(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EPole_System_DragonIK                         pole_system_input;                                 // 0x029B(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ETwist_Type_DragonIK                          arm_twist_axis;                                    // 0x029C(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ERotation_Type_DragonIK                       hand_rotation_method;                              // 0x029D(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          Override_Head_Rotation;                            // 0x029E(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          Enable_Hand_Interpolation;                         // 0x029F(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         Hand_Interpolation_Speed;                          // 0x02A0(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2A4[0x4];                                      // 0x02A4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FDragonData_CustomArmLengths           custom_arm_lengths;                                // 0x02A8(0x0010)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	EInputTransformSpace_DragonIK                 arm_transform_space;                               // 0x02B8(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2B9[0x3];                                      // 0x02B9(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         Main_Arm_Index;                                    // 0x02BC(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2C0[0x120];                                    // 0x02C0(0x0120)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         Lookat_Radius;                                     // 0x03E0(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_3E4[0x4];                                      // 0x03E4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FRotator                               Inner_Body_Clamp;                                  // 0x03E8(0x0018)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	float                                         Lookat_Clamp;                                      // 0x0400(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         Limbs_Clamp;                                       // 0x0404(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FDragonData_CustomLimbClamp            Per_Limbs_Clamp_Array;                             // 0x0408(0x0010)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FRotator                               Extra_Aiming_Rotation_Offset;                      // 0x0418(0x0018)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	float                                         Downward_Dip_Multiplier;                           // 0x0430(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         Inverted_Dip_Multiplier;                           // 0x0434(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         Vertical_Dip_Treshold;                             // 0x0438(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         Side_Move_Multiplier;                              // 0x043C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         Side_Down_Multiplier;                              // 0x0440(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         Up_Rot_Clamp;                                      // 0x0444(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector2D                              Verticle_Range_Angles;                             // 0x0448(0x0010)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector2D                              Horizontal_Range_Angles;                           // 0x0458(0x0010)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         Aim_Frontal_Offset;                                // 0x0468(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_46C[0x4];                                      // 0x046C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FRuntimeFloatCurve                     Look_Bending_Curve;                                // 0x0470(0x0088)(Edit, NativeAccessSpecifierPublic)
	struct FRuntimeFloatCurve                     Look_Multiplier_Curve;                             // 0x04F8(0x0088)(Edit, NativeAccessSpecifierPublic)
	EInputTransformSpace_DragonIK                 look_transform_space;                              // 0x0580(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          Lock_Legs;                                         // 0x0581(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          ignore_elbow_modification;                         // 0x0582(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          ignore_separate_hand_solving;                      // 0x0583(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          Use_Natural_Method;                                // 0x0584(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          Head_Use_Separate_Clamp;                           // 0x0585(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          Is_Head_Accurate;                                  // 0x0586(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          automatic_leg_make;                                // 0x0587(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_588[0x1];                                      // 0x0588(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          enable_solver;                                     // 0x0589(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          Work_Outside_PIE;                                  // 0x058A(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          Use_Physics_Adaptation;                            // 0x058B(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FName                                   physics_root_reference;                            // 0x058C(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          Adaptive_Terrain_Tail;                             // 0x0594(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ETraceTypeQuery                               Trace_Channel;                                     // 0x0595(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_596[0x2];                                      // 0x0596(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         Trace_Up_Height;                                   // 0x0598(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         Trace_Down_Height;                                 // 0x059C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_5A0[0xFC];                                     // 0x05A0(0x00FC)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_910[0x470];                                    // 0x0910(0x0470)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
static_assert(offsetof(FAnimNode_DragonAimSolver, dragon_input_data) == 0x000188, "Member 'FAnimNode_DragonAimSolver::dragon_input_data' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonAimSolver, Aiming_Hand_Limbs) == 0x000250, "Member 'FAnimNode_DragonAimSolver::Aiming_Hand_Limbs' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonAimSolver, Arm_TargetLocation_Overrides) == 0x000270, "Member 'FAnimNode_DragonAimSolver::Arm_TargetLocation_Overrides' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonAimSolver, Use_Separate_Targets) == 0x000280, "Member 'FAnimNode_DragonAimSolver::Use_Separate_Targets' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonAimSolver, Override_Hand_Rotation) == 0x000281, "Member 'FAnimNode_DragonAimSolver::Override_Hand_Rotation' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonAimSolver, enable_head_aim) == 0x000282, "Member 'FAnimNode_DragonAimSolver::enable_head_aim' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonAimSolver, bAllowHandStretching) == 0x000283, "Member 'FAnimNode_DragonAimSolver::bAllowHandStretching' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonAimSolver, Extra_Struct_Elbow_Pole_Array) == 0x000288, "Member 'FAnimNode_DragonAimSolver::Extra_Struct_Elbow_Pole_Array' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonAimSolver, reach_instead) == 0x000298, "Member 'FAnimNode_DragonAimSolver::reach_instead' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonAimSolver, Aggregate_Hand_Body) == 0x000299, "Member 'FAnimNode_DragonAimSolver::Aggregate_Hand_Body' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonAimSolver, Let_Arm_Twist_With_Hand) == 0x00029A, "Member 'FAnimNode_DragonAimSolver::Let_Arm_Twist_With_Hand' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonAimSolver, pole_system_input) == 0x00029B, "Member 'FAnimNode_DragonAimSolver::pole_system_input' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonAimSolver, arm_twist_axis) == 0x00029C, "Member 'FAnimNode_DragonAimSolver::arm_twist_axis' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonAimSolver, hand_rotation_method) == 0x00029D, "Member 'FAnimNode_DragonAimSolver::hand_rotation_method' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonAimSolver, Override_Head_Rotation) == 0x00029E, "Member 'FAnimNode_DragonAimSolver::Override_Head_Rotation' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonAimSolver, Enable_Hand_Interpolation) == 0x00029F, "Member 'FAnimNode_DragonAimSolver::Enable_Hand_Interpolation' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonAimSolver, Hand_Interpolation_Speed) == 0x0002A0, "Member 'FAnimNode_DragonAimSolver::Hand_Interpolation_Speed' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonAimSolver, custom_arm_lengths) == 0x0002A8, "Member 'FAnimNode_DragonAimSolver::custom_arm_lengths' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonAimSolver, arm_transform_space) == 0x0002B8, "Member 'FAnimNode_DragonAimSolver::arm_transform_space' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonAimSolver, Main_Arm_Index) == 0x0002BC, "Member 'FAnimNode_DragonAimSolver::Main_Arm_Index' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonAimSolver, Lookat_Radius) == 0x0003E0, "Member 'FAnimNode_DragonAimSolver::Lookat_Radius' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonAimSolver, Inner_Body_Clamp) == 0x0003E8, "Member 'FAnimNode_DragonAimSolver::Inner_Body_Clamp' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonAimSolver, Lookat_Clamp) == 0x000400, "Member 'FAnimNode_DragonAimSolver::Lookat_Clamp' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonAimSolver, Limbs_Clamp) == 0x000404, "Member 'FAnimNode_DragonAimSolver::Limbs_Clamp' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonAimSolver, Per_Limbs_Clamp_Array) == 0x000408, "Member 'FAnimNode_DragonAimSolver::Per_Limbs_Clamp_Array' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonAimSolver, Extra_Aiming_Rotation_Offset) == 0x000418, "Member 'FAnimNode_DragonAimSolver::Extra_Aiming_Rotation_Offset' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonAimSolver, Downward_Dip_Multiplier) == 0x000430, "Member 'FAnimNode_DragonAimSolver::Downward_Dip_Multiplier' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonAimSolver, Inverted_Dip_Multiplier) == 0x000434, "Member 'FAnimNode_DragonAimSolver::Inverted_Dip_Multiplier' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonAimSolver, Vertical_Dip_Treshold) == 0x000438, "Member 'FAnimNode_DragonAimSolver::Vertical_Dip_Treshold' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonAimSolver, Side_Move_Multiplier) == 0x00043C, "Member 'FAnimNode_DragonAimSolver::Side_Move_Multiplier' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonAimSolver, Side_Down_Multiplier) == 0x000440, "Member 'FAnimNode_DragonAimSolver::Side_Down_Multiplier' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonAimSolver, Up_Rot_Clamp) == 0x000444, "Member 'FAnimNode_DragonAimSolver::Up_Rot_Clamp' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonAimSolver, Verticle_Range_Angles) == 0x000448, "Member 'FAnimNode_DragonAimSolver::Verticle_Range_Angles' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonAimSolver, Horizontal_Range_Angles) == 0x000458, "Member 'FAnimNode_DragonAimSolver::Horizontal_Range_Angles' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonAimSolver, Aim_Frontal_Offset) == 0x000468, "Member 'FAnimNode_DragonAimSolver::Aim_Frontal_Offset' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonAimSolver, Look_Bending_Curve) == 0x000470, "Member 'FAnimNode_DragonAimSolver::Look_Bending_Curve' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonAimSolver, Look_Multiplier_Curve) == 0x0004F8, "Member 'FAnimNode_DragonAimSolver::Look_Multiplier_Curve' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonAimSolver, look_transform_space) == 0x000580, "Member 'FAnimNode_DragonAimSolver::look_transform_space' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonAimSolver, Lock_Legs) == 0x000581, "Member 'FAnimNode_DragonAimSolver::Lock_Legs' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonAimSolver, ignore_elbow_modification) == 0x000582, "Member 'FAnimNode_DragonAimSolver::ignore_elbow_modification' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonAimSolver, ignore_separate_hand_solving) == 0x000583, "Member 'FAnimNode_DragonAimSolver::ignore_separate_hand_solving' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonAimSolver, Use_Natural_Method) == 0x000584, "Member 'FAnimNode_DragonAimSolver::Use_Natural_Method' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonAimSolver, Head_Use_Separate_Clamp) == 0x000585, "Member 'FAnimNode_DragonAimSolver::Head_Use_Separate_Clamp' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonAimSolver, Is_Head_Accurate) == 0x000586, "Member 'FAnimNode_DragonAimSolver::Is_Head_Accurate' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonAimSolver, automatic_leg_make) == 0x000587, "Member 'FAnimNode_DragonAimSolver::automatic_leg_make' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonAimSolver, enable_solver) == 0x000589, "Member 'FAnimNode_DragonAimSolver::enable_solver' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonAimSolver, Work_Outside_PIE) == 0x00058A, "Member 'FAnimNode_DragonAimSolver::Work_Outside_PIE' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonAimSolver, Use_Physics_Adaptation) == 0x00058B, "Member 'FAnimNode_DragonAimSolver::Use_Physics_Adaptation' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonAimSolver, physics_root_reference) == 0x00058C, "Member 'FAnimNode_DragonAimSolver::physics_root_reference' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonAimSolver, Adaptive_Terrain_Tail) == 0x000594, "Member 'FAnimNode_DragonAimSolver::Adaptive_Terrain_Tail' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonAimSolver, Trace_Channel) == 0x000595, "Member 'FAnimNode_DragonAimSolver::Trace_Channel' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonAimSolver, Trace_Up_Height) == 0x000598, "Member 'FAnimNode_DragonAimSolver::Trace_Up_Height' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonAimSolver, Trace_Down_Height) == 0x00059C, "Member 'FAnimNode_DragonAimSolver::Trace_Down_Height' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_450[0x1D4];                                    // 0x0450(0x01D4)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(FAnimNode_DragonFeetSolver, line_trace_upper_height) == 0x000624, "Member 'FAnimNode_DragonFeetSolver::line_trace_upper_height' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonFeetSolver, line_trace_down_height) == 0x000628, "Member 'FAnimNode_DragonFeetSolver::line_trace_down_height' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonFeetSolver, Trace_Down_Multiplier_Curve) == 0x000630, "Member 'FAnimNode_DragonFeetSolver::Trace_Down_Multiplier_Curve' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonFeetSolver, Use_Anti_Channel) == 0x0006B8, "Member 'FAnimNode_DragonFeetSolver::Use_Anti_Channel' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonFeetSolver, use_footstep_listening) == 0x0006B9, "Member 'FAnimNode_DragonFeetSolver::use_footstep_listening' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonFeetSolver, Should_Rotate_Feet) == 0x0006C8, "Member 'FAnimNode_DragonFeetSolver::Should_Rotate_Feet' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonFeetSolver, show_trace_in_game) == 0x0006CA, "Member 'FAnimNode_DragonFeetSolver::show_trace_in_game' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonFeetSolver, execute_in_preview) == 0x0006CB, "Member 'FAnimNode_DragonFeetSolver::execute_in_preview' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonFeetSolver, Enable_Pitch) == 0x0006E8, "Member 'FAnimNode_DragonFeetSolver::Enable_Pitch' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonFeetSolver, Enable_Roll) == 0x0006E9, "Member 'FAnimNode_DragonFeetSolver::Enable_Roll' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonFeetSolver, character_direction_vector_CS) == 0x0006F0, "Member 'FAnimNode_DragonFeetSolver::character_direction_vector_CS' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonFeetSolver, character_forward_direction_vector_CS) == 0x000708, "Member 'FAnimNode_DragonFeetSolver::character_forward_direction_vector_CS' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonFeetSolver, poles_forward_direction_vector_CS) == 0x000720, "Member 'FAnimNode_DragonFeetSolver::poles_forward_direction_vector_CS' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonFeetSolver, Use_Four_Point_Feets) == 0x000738, "Member 'FAnimNode_DragonFeetSolver::Use_Four_Point_Feets' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonFeetSolver, Enable_Foot_Lift_Limit) == 0x000739, "Member 'FAnimNode_DragonFeetSolver::Enable_Foot_Lift_Limit' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonFeetSolver, Affect_Toes_Always) == 0x00073A, "Member 'FAnimNode_DragonFeetSolver::Affect_Toes_Always' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonFeetSolver, Finger_Alpha_Velocity_Curve) == 0x000740, "Member 'FAnimNode_DragonFeetSolver::Finger_Alpha_Velocity_Curve' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonFeetSolver, Max_Limb_Radius) == 0x0007C8, "Member 'FAnimNode_DragonFeetSolver::Max_Limb_Radius' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonFeetSolver, Feet_Lift_Warping) == 0x0007CC, "Member 'FAnimNode_DragonFeetSolver::Feet_Lift_Warping' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonFeetSolver, Feet_Lift_Warp_Multiplier) == 0x0007D0, "Member 'FAnimNode_DragonFeetSolver::Feet_Lift_Warp_Multiplier' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonFeetSolver, feet_vertical_size) == 0x0007D4, "Member 'FAnimNode_DragonFeetSolver::feet_vertical_size' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonFeetSolver, Feet_Lift_Limit) == 0x0007D8, "Member 'FAnimNode_DragonFeetSolver::Feet_Lift_Limit' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonFeetSolver, sticky_feet_mode) == 0x0007DC, "Member 'FAnimNode_DragonFeetSolver::sticky_feet_mode' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonFeetSolver, sticky_feet_on_speed) == 0x0007E0, "Member 'FAnimNode_DragonFeetSolver::sticky_feet_on_speed' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonFeetSolver, sticky_feet_off_speed) == 0x0007E4, "Member 'FAnimNode_DragonFeetSolver::sticky_feet_off_speed' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonFeetSolver, Sticky_Feet_Range) == 0x0007E8, "Member 'FAnimNode_DragonFeetSolver::Sticky_Feet_Range' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonFeetSolver, Lock_Feet_Rotation) == 0x0007EC, "Member 'FAnimNode_DragonFeetSolver::Lock_Feet_Rotation' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonFeetSolver, sticky_feets_data) == 0x0007F0, "Member 'FAnimNode_DragonFeetSolver::sticky_feets_data' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonFeetSolver, sticky_floor_detection) == 0x000810, "Member 'FAnimNode_DragonFeetSolver::sticky_floor_detection' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonFeetSolver, floor_value) == 0x000814, "Member 'FAnimNode_DragonFeetSolver::floor_value' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonFeetSolver, Auto_Sticky_Toggle) == 0x000818, "Member 'FAnimNode_DragonFeetSolver::Auto_Sticky_Toggle' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonFeetSolver, sticky_sockets_data) == 0x000820, "Member 'FAnimNode_DragonFeetSolver::sticky_sockets_data' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_348[0x250];                                    // 0x0348(0x0250)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         Slanted_Height_Up_Offset;                          // 0x0598(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_59C[0x4];                                      // 0x059C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         Slanted_Height_Down_Offset;                        // 0x05A0(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         dip_multiplier;                                    // 0x05A4(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         pelvis_adaptive_gravity;                           // 0x05A8(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          reverse_fabrik;                                    // 0x05AC(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_5AD[0x7];                                      // 0x05AD(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          Calculation_To_RefPose;                            // 0x05B4(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_5B5[0x3];                                      // 0x05B5(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         Chest_Slanted_Height_Up_Offset;                    // 0x05B8(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         Chest_Slanted_Height_Down_Offset;                  // 0x05BC(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         chest_side_dip_multiplier;                         // 0x05C0(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         chest_adaptive_gravity;                            // 0x05C4(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         Chest_Base_Offset;                                 // 0x05C8(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         Pelvis_Base_Offset;                                // 0x05CC(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         virtual_leg_width;                                 // 0x05D0(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         Maximum_Dip_Height;                                // 0x05D4(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_5D8[0x8];                                      // 0x05D8(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FRuntimeFloatCurve                     Pelvis_Height_Multiplier_Curve;                    // 0x05E0(0x0088)(Edit, NativeAccessSpecifierPublic)
	float                                         Maximum_Dip_Height_Chest;                          // 0x0668(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_66C[0x4];                                      // 0x066C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FRuntimeFloatCurve                     Chest_Height_Multiplier_Curve;                     // 0x0670(0x0088)(Edit, NativeAccessSpecifierPublic)
	uint8                                         Pad_6F8[0xC];                                      // 0x06F8(0x000C)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         rotation_power_between;                            // 0x0704(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          Use_Automatic_Fabrik_Selection;                    // 0x0708(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_709[0x3];                                      // 0x0709(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         Trace_Lerp_Speed;                                  // 0x070C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         Location_Lerp_Speed;                               // 0x0710(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_714[0x10];                                     // 0x0714(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         Rotation_Lerp_Speed;                               // 0x0724(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_728[0x8];                                      // 0x0728(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FRuntimeFloatCurve                     Interpolation_Multiplier_Curve;                    // 0x0730(0x0088)(Edit, NativeAccessSpecifierPublic)
	float                                         Chest_Influence_Alpha;                             // 0x07B8(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         Pelvis_ForwardRotation_Intensity;                  // 0x07BC(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         Pelvis_UpwardForwardRotation_Intensity;            // 0x07C0(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         Body_Rotation_Intensity;                           // 0x07C4(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FRotator                               Pelvis_Rotation_Offset_Rotator;                    // 0x07C8(0x0018)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	float                                         Chest_ForwardRotation_Intensity;                   // 0x07E0(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         Chest_UpwardForwardRotation_Intensity;             // 0x07E4(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         Chest_SidewardRotation_Intensity;                  // 0x07E8(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_7EC[0x4];                                      // 0x07EC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FRotator                               Chest_Rotation_Offset_Rotator;                     // 0x07F0(0x0018)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_808[0x68];                                     // 0x0808(0x0068)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          Full_Extended_Spine;                               // 0x0870(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_871[0x3];                                      // 0x0871(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         max_extension_ratio;                               // 0x0874(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         min_extension_ratio;                               // 0x0878(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         extension_switch_speed;                            // 0x087C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_880[0x4];                                      // 0x0880(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          enable_solver;                                     // 0x0884(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          Work_Outside_PIE;                                  // 0x0885(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          Use_Fake_Chest_Rotations;                          // 0x0886(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          Use_Fake_Pelvis_Rotations;                         // 0x0887(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_888[0x4];                                      // 0x0888(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          Force_Activation;                                  // 0x088C(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          accurate_feet_placement;                           // 0x088D(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_88E[0x2];                                      // 0x088E(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	struct FRuntimeFloatCurve                     Accurate_Foot_Curve;                               // 0x0890(0x0088)(Edit, NativeAccessSpecifierPublic)
	bool                                          use_crosshair_trace_also_for_fail_distance;        // 0x0918(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          Only_Root_Solve;                                   // 0x0919(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          Ignore_Chest_Solve;                                // 0x091A(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_91B[0xD];                                      // 0x091B(0x000D)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVector                                Overall_PostSolved_Offset;                         // 0x0928(0x0018)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                character_direction_vector_CS;                     // 0x0940(0x0018)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                Forward_Direction_Vector;                          // 0x0958(0x0018)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          flip_forward_and_right;                            // 0x0970(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_971[0x1F];                                     // 0x0971(0x001F)(Fixing Size After Last Property [ Dumper-7 ])
	ERefPosePluginEnum                            SolverReferencePose;                               // 0x0990(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          Spine_Feet_Connect;                                // 0x0991(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_992[0x3C2];                                    // 0x0992(0x03C2)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         Snake_Joint_Speed;                                 // 0x0D54(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          Enable_Snake_Interpolation;                        // 0x0D58(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          is_snake;                                          // 0x0D59(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          Ignore_End_Points;                                 // 0x0D5A(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_D5B[0x1];                                      // 0x0D5B(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         Maximum_Feet_Distance;                             // 0x0D5C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         Minimum_Feet_Distance;                             // 0x0D60(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          DisplayLineTrace;                                  // 0x0D64(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_D65[0x15B];                                    // 0x0D65(0x015B)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FAnimNode_DragonSpineSolver) == 0x000010, "Wrong alignment on FAnimNode_DragonSpineSolver");
static_assert(sizeof(FAnimNode_DragonSpineSolver) == 0x000EC0, "Wrong size on FAnimNode_DragonSpineSolver");
...
static_assert(offsetof(FAnimNode_DragonSpineSolver, Slanted_Height_Up_Offset) == 0x000598, "Member 'FAnimNode_DragonSpineSolver::Slanted_Height_Up_Offset' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonSpineSolver, Slanted_Height_Down_Offset) == 0x0005A0, "Member 'FAnimNode_DragonSpineSolver::Slanted_Height_Down_Offset' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonSpineSolver, dip_multiplier) == 0x0005A4, "Member 'FAnimNode_DragonSpineSolver::dip_multiplier' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonSpineSolver, pelvis_adaptive_gravity) == 0x0005A8, "Member 'FAnimNode_DragonSpineSolver::pelvis_adaptive_gravity' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonSpineSolver, reverse_fabrik) == 0x0005AC, "Member 'FAnimNode_DragonSpineSolver::reverse_fabrik' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonSpineSolver, Calculation_To_RefPose) == 0x0005B4, "Member 'FAnimNode_DragonSpineSolver::Calculation_To_RefPose' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonSpineSolver, Chest_Slanted_Height_Up_Offset) == 0x0005B8, "Member 'FAnimNode_DragonSpineSolver::Chest_Slanted_Height_Up_Offset' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonSpineSolver, Chest_Slanted_Height_Down_Offset) == 0x0005BC, "Member 'FAnimNode_DragonSpineSolver::Chest_Slanted_Height_Down_Offset' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonSpineSolver, chest_side_dip_multiplier) == 0x0005C0, "Member 'FAnimNode_DragonSpineSolver::chest_side_dip_multiplier' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonSpineSolver, chest_adaptive_gravity) == 0x0005C4, "Member 'FAnimNode_DragonSpineSolver::chest_adaptive_gravity' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonSpineSolver, Chest_Base_Offset) == 0x0005C8, "Member 'FAnimNode_DragonSpineSolver::Chest_Base_Offset' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonSpineSolver, Pelvis_Base_Offset) == 0x0005CC, "Member 'FAnimNode_DragonSpineSolver::Pelvis_Base_Offset' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonSpineSolver, virtual_leg_width) == 0x0005D0, "Member 'FAnimNode_DragonSpineSolver::virtual_leg_width' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonSpineSolver, Maximum_Dip_Height) == 0x0005D4, "Member 'FAnimNode_DragonSpineSolver::Maximum_Dip_Height' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonSpineSolver, Pelvis_Height_Multiplier_Curve) == 0x0005E0, "Member 'FAnimNode_DragonSpineSolver::Pelvis_Height_Multiplier_Curve' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonSpineSolver, Maximum_Dip_Height_Chest) == 0x000668, "Member 'FAnimNode_DragonSpineSolver::Maximum_Dip_Height_Chest' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonSpineSolver, Chest_Height_Multiplier_Curve) == 0x000670, "Member 'FAnimNode_DragonSpineSolver::Chest_Height_Multiplier_Curve' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonSpineSolver, rotation_power_between) == 0x000704, "Member 'FAnimNode_DragonSpineSolver::rotation_power_between' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonSpineSolver, Use_Automatic_Fabrik_Selection) == 0x000708, "Member 'FAnimNode_DragonSpineSolver::Use_Automatic_Fabrik_Selection' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonSpineSolver, Trace_Lerp_Speed) == 0x00070C, "Member 'FAnimNode_DragonSpineSolver::Trace_Lerp_Speed' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonSpineSolver, Location_Lerp_Speed) == 0x000710, "Member 'FAnimNode_DragonSpineSolver::Location_Lerp_Speed' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonSpineSolver, Rotation_Lerp_Speed) == 0x000724, "Member 'FAnimNode_DragonSpineSolver::Rotation_Lerp_Speed' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonSpineSolver, Interpolation_Multiplier_Curve) == 0x000730, "Member 'FAnimNode_DragonSpineSolver::Interpolation_Multiplier_Curve' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonSpineSolver, Chest_Influence_Alpha) == 0x0007B8, "Member 'FAnimNode_DragonSpineSolver::Chest_Influence_Alpha' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonSpineSolver, Pelvis_ForwardRotation_Intensity) == 0x0007BC, "Member 'FAnimNode_DragonSpineSolver::Pelvis_ForwardRotation_Intensity' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonSpineSolver, Pelvis_UpwardForwardRotation_Intensity) == 0x0007C0, "Member 'FAnimNode_DragonSpineSolver::Pelvis_UpwardForwardRotation_Intensity' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonSpineSolver, Body_Rotation_Intensity) == 0x0007C4, "Member 'FAnimNode_DragonSpineSolver::Body_Rotation_Intensity' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonSpineSolver, Pelvis_Rotation_Offset_Rotator) == 0x0007C8, "Member 'FAnimNode_DragonSpineSolver::Pelvis_Rotation_Offset_Rotator' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonSpineSolver, Chest_ForwardRotation_Intensity) == 0x0007E0, "Member 'FAnimNode_DragonSpineSolver::Chest_ForwardRotation_Intensity' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonSpineSolver, Chest_UpwardForwardRotation_Intensity) == 0x0007E4, "Member 'FAnimNode_DragonSpineSolver::Chest_UpwardForwardRotation_Intensity' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonSpineSolver, Chest_SidewardRotation_Intensity) == 0x0007E8, "Member 'FAnimNode_DragonSpineSolver::Chest_SidewardRotation_Intensity' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonSpineSolver, Chest_Rotation_Offset_Rotator) == 0x0007F0, "Member 'FAnimNode_DragonSpineSolver::Chest_Rotation_Offset_Rotator' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonSpineSolver, Full_Extended_Spine) == 0x000870, "Member 'FAnimNode_DragonSpineSolver::Full_Extended_Spine' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonSpineSolver, max_extension_ratio) == 0x000874, "Member 'FAnimNode_DragonSpineSolver::max_extension_ratio' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonSpineSolver, min_extension_ratio) == 0x000878, "Member 'FAnimNode_DragonSpineSolver::min_extension_ratio' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonSpineSolver, extension_switch_speed) == 0x00087C, "Member 'FAnimNode_DragonSpineSolver::extension_switch_speed' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonSpineSolver, enable_solver) == 0x000884, "Member 'FAnimNode_DragonSpineSolver::enable_solver' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonSpineSolver, Work_Outside_PIE) == 0x000885, "Member 'FAnimNode_DragonSpineSolver::Work_Outside_PIE' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonSpineSolver, Use_Fake_Chest_Rotations) == 0x000886, "Member 'FAnimNode_DragonSpineSolver::Use_Fake_Chest_Rotations' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonSpineSolver, Use_Fake_Pelvis_Rotations) == 0x000887, "Member 'FAnimNode_DragonSpineSolver::Use_Fake_Pelvis_Rotations' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonSpineSolver, Force_Activation) == 0x00088C, "Member 'FAnimNode_DragonSpineSolver::Force_Activation' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonSpineSolver, accurate_feet_placement) == 0x00088D, "Member 'FAnimNode_DragonSpineSolver::accurate_feet_placement' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonSpineSolver, Accurate_Foot_Curve) == 0x000890, "Member 'FAnimNode_DragonSpineSolver::Accurate_Foot_Curve' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonSpineSolver, use_crosshair_trace_also_for_fail_distance) == 0x000918, "Member 'FAnimNode_DragonSpineSolver::use_crosshair_trace_also_for_fail_distance' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonSpineSolver, Only_Root_Solve) == 0x000919, "Member 'FAnimNode_DragonSpineSolver::Only_Root_Solve' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonSpineSolver, Ignore_Chest_Solve) == 0x00091A, "Member 'FAnimNode_DragonSpineSolver::Ignore_Chest_Solve' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonSpineSolver, Overall_PostSolved_Offset) == 0x000928, "Member 'FAnimNode_DragonSpineSolver::Overall_PostSolved_Offset' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonSpineSolver, character_direction_vector_CS) == 0x000940, "Member 'FAnimNode_DragonSpineSolver::character_direction_vector_CS' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonSpineSolver, Forward_Direction_Vector) == 0x000958, "Member 'FAnimNode_DragonSpineSolver::Forward_Direction_Vector' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonSpineSolver, flip_forward_and_right) == 0x000970, "Member 'FAnimNode_DragonSpineSolver::flip_forward_and_right' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonSpineSolver, SolverReferencePose) == 0x000990, "Member 'FAnimNode_DragonSpineSolver::SolverReferencePose' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonSpineSolver, Spine_Feet_Connect) == 0x000991, "Member 'FAnimNode_DragonSpineSolver::Spine_Feet_Connect' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonSpineSolver, Snake_Joint_Speed) == 0x000D54, "Member 'FAnimNode_DragonSpineSolver::Snake_Joint_Speed' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonSpineSolver, Enable_Snake_Interpolation) == 0x000D58, "Member 'FAnimNode_DragonSpineSolver::Enable_Snake_Interpolation' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonSpineSolver, is_snake) == 0x000D59, "Member 'FAnimNode_DragonSpineSolver::is_snake' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonSpineSolver, Ignore_End_Points) == 0x000D5A, "Member 'FAnimNode_DragonSpineSolver::Ignore_End_Points' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonSpineSolver, Maximum_Feet_Distance) == 0x000D5C, "Member 'FAnimNode_DragonSpineSolver::Maximum_Feet_Distance' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonSpineSolver, Minimum_Feet_Distance) == 0x000D60, "Member 'FAnimNode_DragonSpineSolver::Minimum_Feet_Distance' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonSpineSolver, DisplayLineTrace) == 0x000D64, "Member 'FAnimNode_DragonSpineSolver::DisplayLineTrace' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_4A7[0x10E];                                    // 0x04A7(0x010E)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          Enable_Interpolation;                              // 0x05B5(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_5B6[0x2];                                      // 0x05B6(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         Interpolation_Speed;                               // 0x05B8(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_5BC[0x64];                                     // 0x05BC(0x0064)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVector                                LookAt_Axis;                                       // 0x0620(0x0018)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                Upward_Axis;                                       // 0x0638(0x0018)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          Use_Physics_Adaptation;                            // 0x0650(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_651[0x3];                                      // 0x0651(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	class FName                                   physics_root_reference;                            // 0x0654(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_65C[0x108];                                    // 0x065C(0x0108)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          DisplayLineTrace;                                  // 0x0764(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_765[0x3];                                      // 0x0765(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FTransform>                     Debug_Hand_Locations;                              // 0x0768(0x0010)(Edit, EditFixedSize, ZeroConstructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_778[0x298];                                    // 0x0778(0x0298)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FAnimNode_DragonTwistArmSolver) == 0x000010, "Wrong alignment on FAnimNode_DragonTwistArmSolver");
static_assert(sizeof(FAnimNode_DragonTwistArmSolver) == 0x000A10, "Wrong size on FAnimNode_DragonTwistArmSolver");
...
static_assert(offsetof(FAnimNode_DragonTwistArmSolver, Enable_Interpolation) == 0x0005B5, "Member 'FAnimNode_DragonTwistArmSolver::Enable_Interpolation' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonTwistArmSolver, Interpolation_Speed) == 0x0005B8, "Member 'FAnimNode_DragonTwistArmSolver::Interpolation_Speed' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonTwistArmSolver, LookAt_Axis) == 0x000620, "Member 'FAnimNode_DragonTwistArmSolver::LookAt_Axis' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonTwistArmSolver, Upward_Axis) == 0x000638, "Member 'FAnimNode_DragonTwistArmSolver::Upward_Axis' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonTwistArmSolver, Use_Physics_Adaptation) == 0x000650, "Member 'FAnimNode_DragonTwistArmSolver::Use_Physics_Adaptation' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonTwistArmSolver, physics_root_reference) == 0x000654, "Member 'FAnimNode_DragonTwistArmSolver::physics_root_reference' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonTwistArmSolver, DisplayLineTrace) == 0x000764, "Member 'FAnimNode_DragonTwistArmSolver::DisplayLineTrace' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonTwistArmSolver, Debug_Hand_Locations) == 0x000768, "Member 'FAnimNode_DragonTwistArmSolver::Debug_Hand_Locations' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_2F6[0x10F];                                    // 0x02F6(0x010F)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          Enable_Interpolation;                              // 0x0405(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_406[0x2];                                      // 0x0406(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         Interpolation_Speed;                               // 0x0408(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_40C[0x334];                                    // 0x040C(0x0334)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVector                                LookAt_Axis;                                       // 0x0740(0x0018)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                Upward_Axis;                                       // 0x0758(0x0018)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_770[0x148];                                    // 0x0770(0x0148)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          DisplayLineTrace;                                  // 0x08B8(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_8B9[0x7];                                      // 0x08B9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FTransform>                     Debug_Hand_Locations;                              // 0x08C0(0x0010)(Edit, EditFixedSize, ZeroConstructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_8D0[0x2A0];                                    // 0x08D0(0x02A0)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
static_assert(offsetof(FAnimNode_DragonWeaponArmSolver, Enable_Interpolation) == 0x000405, "Member 'FAnimNode_DragonWeaponArmSolver::Enable_Interpolation' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonWeaponArmSolver, Interpolation_Speed) == 0x000408, "Member 'FAnimNode_DragonWeaponArmSolver::Interpolation_Speed' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonWeaponArmSolver, LookAt_Axis) == 0x000740, "Member 'FAnimNode_DragonWeaponArmSolver::LookAt_Axis' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonWeaponArmSolver, Upward_Axis) == 0x000758, "Member 'FAnimNode_DragonWeaponArmSolver::Upward_Axis' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonWeaponArmSolver, DisplayLineTrace) == 0x0008B8, "Member 'FAnimNode_DragonWeaponArmSolver::DisplayLineTrace' has a wrong offset!");
static_assert(offsetof(FAnimNode_DragonWeaponArmSolver, Debug_Hand_Locations) == 0x0008C0, "Member 'FAnimNode_DragonWeaponArmSolver::Debug_Hand_Locations' has a wrong offset!");
...
static_assert(sizeof(FDragonTailChainLink) == 0x000270, "Wrong size on FDragonTailChainLink");
...
public:
	...
	bool                                          use_custom_heights;                                // 0x0118(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_119[0x3];                                      // 0x0119(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         Tail_Bone_Height;                                  // 0x011C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FDragonData_TailHeightInput            Custom_Bone_Heights;                               // 0x0120(0x0010)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FVector                                character_direction_vector_CS;                     // 0x0130(0x0018)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_148[0x10];                                     // 0x0148(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         Animation_Interpolation_Speed;                     // 0x0158(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ETraceTypeQuery                               Trace_Channel;                                     // 0x015C(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          line_trace_hit_complex;                            // 0x015D(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          Use_Sphere_Trace;                                  // 0x015E(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_15F[0x1];                                      // 0x015F(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         Sphere_Trace_Radius;                               // 0x0160(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_164[0xCC];                                     // 0x0164(0x00CC)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         Trace_Up_Height;                                   // 0x0230(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         Trace_Down_Height;                                 // 0x0234(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         TraceBlock_Interpolation_Speed;                    // 0x0238(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         TraceUnBlock_Interpolation_Speed;                  // 0x023C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_240[0x40];                                     // 0x0240(0x0040)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         trace_interval_duration;                           // 0x0280(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          Use_LOD_Specific_Intervals;                        // 0x0284(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_285[0x3];                                      // 0x0285(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         LOD0_Interval;                                     // 0x0288(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         LOD1_Interval;                                     // 0x028C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         LOD2_Interval;                                     // 0x0290(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          Use_Trace_Distance_Adapting;                       // 0x0294(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_295[0x3];                                      // 0x0295(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         Trace_Max_Distance;                                // 0x0298(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_29C[0x4];                                      // 0x029C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FTransform                             CachedEffectorCSTransform;                         // 0x02A0(0x0060)(Edit, BlueprintVisible, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_300[0x70];                                     // 0x0300(0x0070)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FAnimNode_TailSolver) == 0x000010, "Wrong alignment on FAnimNode_TailSolver");
static_assert(sizeof(FAnimNode_TailSolver) == 0x000370, "Wrong size on FAnimNode_TailSolver");
...
static_assert(offsetof(FAnimNode_TailSolver, use_custom_heights) == 0x000118, "Member 'FAnimNode_TailSolver::use_custom_heights' has a wrong offset!");
static_assert(offsetof(FAnimNode_TailSolver, Tail_Bone_Height) == 0x00011C, "Member 'FAnimNode_TailSolver::Tail_Bone_Height' has a wrong offset!");
static_assert(offsetof(FAnimNode_TailSolver, Custom_Bone_Heights) == 0x000120, "Member 'FAnimNode_TailSolver::Custom_Bone_Heights' has a wrong offset!");
static_assert(offsetof(FAnimNode_TailSolver, character_direction_vector_CS) == 0x000130, "Member 'FAnimNode_TailSolver::character_direction_vector_CS' has a wrong offset!");
static_assert(offsetof(FAnimNode_TailSolver, Animation_Interpolation_Speed) == 0x000158, "Member 'FAnimNode_TailSolver::Animation_Interpolation_Speed' has a wrong offset!");
static_assert(offsetof(FAnimNode_TailSolver, Trace_Channel) == 0x00015C, "Member 'FAnimNode_TailSolver::Trace_Channel' has a wrong offset!");
static_assert(offsetof(FAnimNode_TailSolver, line_trace_hit_complex) == 0x00015D, "Member 'FAnimNode_TailSolver::line_trace_hit_complex' has a wrong offset!");
static_assert(offsetof(FAnimNode_TailSolver, Use_Sphere_Trace) == 0x00015E, "Member 'FAnimNode_TailSolver::Use_Sphere_Trace' has a wrong offset!");
static_assert(offsetof(FAnimNode_TailSolver, Sphere_Trace_Radius) == 0x000160, "Member 'FAnimNode_TailSolver::Sphere_Trace_Radius' has a wrong offset!");
static_assert(offsetof(FAnimNode_TailSolver, Trace_Up_Height) == 0x000230, "Member 'FAnimNode_TailSolver::Trace_Up_Height' has a wrong offset!");
static_assert(offsetof(FAnimNode_TailSolver, Trace_Down_Height) == 0x000234, "Member 'FAnimNode_TailSolver::Trace_Down_Height' has a wrong offset!");
static_assert(offsetof(FAnimNode_TailSolver, TraceBlock_Interpolation_Speed) == 0x000238, "Member 'FAnimNode_TailSolver::TraceBlock_Interpolation_Speed' has a wrong offset!");
static_assert(offsetof(FAnimNode_TailSolver, TraceUnBlock_Interpolation_Speed) == 0x00023C, "Member 'FAnimNode_TailSolver::TraceUnBlock_Interpolation_Speed' has a wrong offset!");
static_assert(offsetof(FAnimNode_TailSolver, trace_interval_duration) == 0x000280, "Member 'FAnimNode_TailSolver::trace_interval_duration' has a wrong offset!");
static_assert(offsetof(FAnimNode_TailSolver, Use_LOD_Specific_Intervals) == 0x000284, "Member 'FAnimNode_TailSolver::Use_LOD_Specific_Intervals' has a wrong offset!");
static_assert(offsetof(FAnimNode_TailSolver, LOD0_Interval) == 0x000288, "Member 'FAnimNode_TailSolver::LOD0_Interval' has a wrong offset!");
static_assert(offsetof(FAnimNode_TailSolver, LOD1_Interval) == 0x00028C, "Member 'FAnimNode_TailSolver::LOD1_Interval' has a wrong offset!");
static_assert(offsetof(FAnimNode_TailSolver, LOD2_Interval) == 0x000290, "Member 'FAnimNode_TailSolver::LOD2_Interval' has a wrong offset!");
static_assert(offsetof(FAnimNode_TailSolver, Use_Trace_Distance_Adapting) == 0x000294, "Member 'FAnimNode_TailSolver::Use_Trace_Distance_Adapting' has a wrong offset!");
static_assert(offsetof(FAnimNode_TailSolver, Trace_Max_Distance) == 0x000298, "Member 'FAnimNode_TailSolver::Trace_Max_Distance' has a wrong offset!");
static_assert(offsetof(FAnimNode_TailSolver, CachedEffectorCSTransform) == 0x0002A0, "Member 'FAnimNode_TailSolver::CachedEffectorCSTransform' has a wrong offset!");
...
static_assert(sizeof(FDragonIKTraceMParams) == 0x000148, "Wrong size on FDragonIKTraceMParams");
...
public:
	class FName                                   Key;                                               // 0x0000(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FDragonIKTraceMParams                  trace_params;                                      // 0x0008(0x0148)(Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(FDragonIKTraceParamKeyValuePair) == 0x000008, "Wrong alignment on FDragonIKTraceParamKeyValuePair");
static_assert(sizeof(FDragonIKTraceParamKeyValuePair) == 0x000150, "Wrong size on FDragonIKTraceParamKeyValuePair");
