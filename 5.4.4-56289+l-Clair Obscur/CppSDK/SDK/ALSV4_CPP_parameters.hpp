...
{
public:
	class USkeletalMesh*                          NewVisibleMesh;                                    // 0x0000(0x0008)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
static_assert(offsetof(ALSBaseCharacter_OnRep_VisibleMesh, NewVisibleMesh) == 0x000000, "Member 'ALSBaseCharacter_OnRep_VisibleMesh::NewVisibleMesh' has a wrong offset!");
...
// 0x0010 (0x0010 - 0x0000)
struct ALSBaseCharacter_SetMovementModel final
{
public:
	struct FDataTableRowHandle                    Model;                                             // 0x0000(0x0010)(Parm, NoDestructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(ALSBaseCharacter_SetMovementModel) == 0x000008, "Wrong alignment on ALSBaseCharacter_SetMovementModel");
static_assert(sizeof(ALSBaseCharacter_SetMovementModel) == 0x000010, "Wrong size on ALSBaseCharacter_SetMovementModel");
static_assert(offsetof(ALSBaseCharacter_SetMovementModel, Model) == 0x000000, "Member 'ALSBaseCharacter_SetMovementModel::Model' has a wrong offset!");
...
static_assert(offsetof(ALSMantleComponent_MantleCheck, ReturnValue) == 0x000015, "Member 'ALSMantleComponent_MantleCheck::ReturnValue' has a wrong offset!");
...
// 0x0001 (0x0001 - 0x0000)
struct ALSPlayerController_AreStreamingSourcesEnabled final
{
public:
	bool                                          ReturnValue;                                       // 0x0000(0x0001)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(ALSPlayerController_AreStreamingSourcesEnabled) == 0x000001, "Wrong alignment on ALSPlayerController_AreStreamingSourcesEnabled");
static_assert(sizeof(ALSPlayerController_AreStreamingSourcesEnabled) == 0x000001, "Wrong size on ALSPlayerController_AreStreamingSourcesEnabled");
static_assert(offsetof(ALSPlayerController_AreStreamingSourcesEnabled, ReturnValue) == 0x000000, "Member 'ALSPlayerController_AreStreamingSourcesEnabled::ReturnValue' has a wrong offset!");
