...
class UCommonActivatableWidget* UCommonActivatableWidget::GetVirtualTreeParent()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("CommonActivatableWidget", "GetVirtualTreeParent");

	Params::CommonActivatableWidget_GetVirtualTreeParent Parms{};
...
class UMediaPlayer* UCommonVideoPlayer::GetInternalMediaPlayer() const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("CommonVideoPlayer", "GetInternalMediaPlayer");

	Params::CommonVideoPlayer_GetInternalMediaPlayer Parms{};
...
// (Event, Protected, HasOutParams, BlueprintEvent)
// Parameters:
// const class FText&                      InActionText                                           (ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)

void UCommonBoundActionButton::OnActionTextUpdate(const class FText& InActionText)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("CommonBoundActionButton", "OnActionTextUpdate");

	Params::CommonBoundActionButton_OnActionTextUpdate Parms{};
