...
// Function SmartObjectsModule.SmartObjectSubsystem.Abort
// 0x0028 (0x0028 - 0x0000)
struct SmartObjectSubsystem_Abort final
{
public:
...
static_assert(alignof(SmartObjectSubsystem_Abort) == 0x000008, "Wrong alignment on SmartObjectSubsystem_Abort");
static_assert(sizeof(SmartObjectSubsystem_Abort) == 0x000028, "Wrong size on SmartObjectSubsystem_Abort");
static_assert(offsetof(SmartObjectSubsystem_Abort, ClaimHandle) == 0x000000, "Member 'SmartObjectSubsystem_Abort::ClaimHandle' has a wrong offset!");
static_assert(offsetof(SmartObjectSubsystem_Abort, ReturnValue) == 0x000020, "Member 'SmartObjectSubsystem_Abort::ReturnValue' has a wrong offset!");
