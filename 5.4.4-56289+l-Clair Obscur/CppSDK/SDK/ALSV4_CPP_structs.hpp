...
public:
	...
	class UPrimitiveComponent*                    Component;                                         // 0x0060(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
{
public:
	float                                         WalkSpeed;                                         // 0x0000(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         RunSpeed;                                          // 0x0004(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         SprintSpeed;                                       // 0x0008(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_C[0x4];                                        // 0x000C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UCurveVector*                           MovementCurve;                                     // 0x0010(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UCurveFloat*                            RotationRateCurve;                                 // 0x0018(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	TSoftObjectPtr<class USoundBase>              Sound;                                             // 0x0010(0x0028)(Edit, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EALSSpawnType                                 SoundSpawnType;                                    // 0x0038(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EAttachLocation                               SoundAttachmentType;                               // 0x0039(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_3A[0x6];                                       // 0x003A(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVector                                SoundLocationOffset;                               // 0x0040(0x0018)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FRotator                               SoundRotationOffset;                               // 0x0058(0x0018)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	TSoftObjectPtr<class UMaterialInterface>      DecalMaterial;                                     // 0x0070(0x0028)(Edit, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EALSSpawnType                                 DecalSpawnType;                                    // 0x0098(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EAttachLocation                               DecalAttachmentType;                               // 0x0099(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_9A[0x2];                                       // 0x009A(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         DecalLifeSpan;                                     // 0x009C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                DecalSize;                                         // 0x00A0(0x0018)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                DecalLocationOffset;                               // 0x00B8(0x0018)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FRotator                               DecalRotationOffset;                               // 0x00D0(0x0018)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	TSoftObjectPtr<class UNiagaraSystem>          NiagaraSystem;                                     // 0x00E8(0x0028)(Edit, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EALSSpawnType                                 NiagaraSpawnType;                                  // 0x0110(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EAttachLocation                               NiagaraAttachmentType;                             // 0x0111(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_112[0x6];                                      // 0x0112(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVector                                NiagaraLocationOffset;                             // 0x0118(0x0018)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FRotator                               NiagaraRotationOffset;                             // 0x0130(0x0018)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(FALSHitFX) == 0x000008, "Wrong alignment on FALSHitFX");
static_assert(sizeof(FALSHitFX) == 0x000148, "Wrong size on FALSHitFX");
...
static_assert(offsetof(FALSHitFX, SoundSpawnType) == 0x000038, "Member 'FALSHitFX::SoundSpawnType' has a wrong offset!");
static_assert(offsetof(FALSHitFX, SoundAttachmentType) == 0x000039, "Member 'FALSHitFX::SoundAttachmentType' has a wrong offset!");
static_assert(offsetof(FALSHitFX, SoundLocationOffset) == 0x000040, "Member 'FALSHitFX::SoundLocationOffset' has a wrong offset!");
static_assert(offsetof(FALSHitFX, SoundRotationOffset) == 0x000058, "Member 'FALSHitFX::SoundRotationOffset' has a wrong offset!");
static_assert(offsetof(FALSHitFX, DecalMaterial) == 0x000070, "Member 'FALSHitFX::DecalMaterial' has a wrong offset!");
static_assert(offsetof(FALSHitFX, DecalSpawnType) == 0x000098, "Member 'FALSHitFX::DecalSpawnType' has a wrong offset!");
static_assert(offsetof(FALSHitFX, DecalAttachmentType) == 0x000099, "Member 'FALSHitFX::DecalAttachmentType' has a wrong offset!");
static_assert(offsetof(FALSHitFX, DecalLifeSpan) == 0x00009C, "Member 'FALSHitFX::DecalLifeSpan' has a wrong offset!");
static_assert(offsetof(FALSHitFX, DecalSize) == 0x0000A0, "Member 'FALSHitFX::DecalSize' has a wrong offset!");
static_assert(offsetof(FALSHitFX, DecalLocationOffset) == 0x0000B8, "Member 'FALSHitFX::DecalLocationOffset' has a wrong offset!");
static_assert(offsetof(FALSHitFX, DecalRotationOffset) == 0x0000D0, "Member 'FALSHitFX::DecalRotationOffset' has a wrong offset!");
static_assert(offsetof(FALSHitFX, NiagaraSystem) == 0x0000E8, "Member 'FALSHitFX::NiagaraSystem' has a wrong offset!");
static_assert(offsetof(FALSHitFX, NiagaraSpawnType) == 0x000110, "Member 'FALSHitFX::NiagaraSpawnType' has a wrong offset!");
static_assert(offsetof(FALSHitFX, NiagaraAttachmentType) == 0x000111, "Member 'FALSHitFX::NiagaraAttachmentType' has a wrong offset!");
static_assert(offsetof(FALSHitFX, NiagaraLocationOffset) == 0x000118, "Member 'FALSHitFX::NiagaraLocationOffset' has a wrong offset!");
static_assert(offsetof(FALSHitFX, NiagaraRotationOffset) == 0x000130, "Member 'FALSHitFX::NiagaraRotationOffset' has a wrong offset!");
