...
#include "BP_GameAction_GoToCamp_classes.hpp"
#include "BP_GameAction_GoToCamp_parameters.hpp"
...
void UBP_GameAction_GoToCamp_C::ValidateGameAction(TArray<class FText>& ErrorMessages, class FString& PropertyPath, bool& ExploreAssetChildren)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_GameAction_GoToCamp_C", "ValidateGameAction");

	Params::BP_GameAction_GoToCamp_C_ValidateGameAction Parms{};
...
TSubclassOf<class UGameActionInstance> UBP_GameAction_GoToCamp_C::GetInstanceClass()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_GameAction_GoToCamp_C", "GetInstanceClass");

	Params::BP_GameAction_GoToCamp_C_GetInstanceClass Parms{};
