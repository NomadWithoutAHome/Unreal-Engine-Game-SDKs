...
#include "BP_GameAction_ShowCredits_classes.hpp"
#include "BP_GameAction_ShowCredits_parameters.hpp"
...
TSubclassOf<class UGameActionInstance> UBP_GameAction_ShowCredits_C::GetInstanceClass()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_GameAction_ShowCredits_C", "GetInstanceClass");

	Params::BP_GameAction_ShowCredits_C_GetInstanceClass Parms{};
...
void UBP_GameAction_ShowCredits_C::ValidateGameAction(TArray<class FText>& ErrorMessages, class FString& PropertyPath, bool& ExploreAssetChildren)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_GameAction_ShowCredits_C", "ValidateGameAction");

	Params::BP_GameAction_ShowCredits_C_ValidateGameAction Parms{};
