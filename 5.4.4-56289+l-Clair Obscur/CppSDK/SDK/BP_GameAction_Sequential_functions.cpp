...
#include "BP_GameAction_Sequential_classes.hpp"
#include "BP_GameAction_Sequential_parameters.hpp"
...
TSubclassOf<class UGameActionInstance> UBP_GameAction_Sequential_C::GetInstanceClass()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_GameAction_Sequential_C", "GetInstanceClass");

	Params::BP_GameAction_Sequential_C_GetInstanceClass Parms{};
...
void UBP_GameAction_Sequential_C::ValidateGameAction(TArray<class FText>& ErrorMessages, class FString& PropertyPath, bool& ExploreAssetChildren)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_GameAction_Sequential_C", "ValidateGameAction");

	Params::BP_GameAction_Sequential_C_ValidateGameAction Parms{};
