...
bool USmartObjectSubsystem::Abort(const struct FSmartObjectClaimHandle& ClaimHandle)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("SmartObjectSubsystem", "Abort");

	Params::SmartObjectSubsystem_Abort Parms{};
