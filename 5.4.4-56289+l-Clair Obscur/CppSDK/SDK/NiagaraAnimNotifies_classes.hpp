...
static_assert(offsetof(UAnimNotifyState_TimedNiagaraEffect, bApplyRateScaleAsTimeDilation) == 0x000078, "Member 'UAnimNotifyState_TimedNiagaraEffect::bApplyRateScaleAsTimeDilation' has a wrong offset!");
static_assert(offsetof(UAnimNotifyState_TimedNiagaraEffect, bDestroyAtEnd) == 0x000079, "Member 'UAnimNotifyState_TimedNiagaraEffect::bDestroyAtEnd' has a wrong offset!");
...
static_assert(offsetof(UAnimNotifyState_TimedNiagaraEffectAdvanced, bApplyRateScaleToProgress) == 0x000081, "Member 'UAnimNotifyState_TimedNiagaraEffectAdvanced::bApplyRateScaleToProgress' has a wrong offset!");
