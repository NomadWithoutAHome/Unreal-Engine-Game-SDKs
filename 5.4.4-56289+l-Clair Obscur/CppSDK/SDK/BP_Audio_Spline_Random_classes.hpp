...
// BlueprintGeneratedClass BP_Audio_Spline_Random.BP_Audio_Spline_Random_C
// 0x0038 (0x02C8 - 0x0290)
class ABP_Audio_Spline_Random_C final : public AActor
{
public:
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"BP_Audio_Spline_Random_C">();
	}
	static class ABP_Audio_Spline_Random_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<ABP_Audio_Spline_Random_C>();
	}
};
static_assert(alignof(ABP_Audio_Spline_Random_C) == 0x000008, "Wrong alignment on ABP_Audio_Spline_Random_C");
static_assert(sizeof(ABP_Audio_Spline_Random_C) == 0x0002C8, "Wrong size on ABP_Audio_Spline_Random_C");
static_assert(offsetof(ABP_Audio_Spline_Random_C, UberGraphFrame) == 0x000290, "Member 'ABP_Audio_Spline_Random_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(ABP_Audio_Spline_Random_C, Spline) == 0x000298, "Member 'ABP_Audio_Spline_Random_C::Spline' has a wrong offset!");
static_assert(offsetof(ABP_Audio_Spline_Random_C, SoundData) == 0x0002A0, "Member 'ABP_Audio_Spline_Random_C::SoundData' has a wrong offset!");
static_assert(offsetof(ABP_Audio_Spline_Random_C, _NumberOfPointsToSearch) == 0x0002B0, "Member 'ABP_Audio_Spline_Random_C::_NumberOfPointsToSearch' has a wrong offset!");
static_assert(offsetof(ABP_Audio_Spline_Random_C, DEBUG_DrawPlayedSoundEnable) == 0x0002B4, "Member 'ABP_Audio_Spline_Random_C::DEBUG_DrawPlayedSoundEnable' has a wrong offset!");
static_assert(offsetof(ABP_Audio_Spline_Random_C, RuntimeSoundData) == 0x0002B8, "Member 'ABP_Audio_Spline_Random_C::RuntimeSoundData' has a wrong offset!");
