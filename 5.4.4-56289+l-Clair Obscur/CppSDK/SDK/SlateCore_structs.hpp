...
public:
	...
	bool                                          bIsOnLeftSide;                                     // 0x0764(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_765[0xB];                                      // 0x0765(0x000B)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
static_assert(offsetof(FScrollBarStyle, bIsOnLeftSide) == 0x000764, "Member 'FScrollBarStyle::bIsOnLeftSide' has a wrong offset!");
