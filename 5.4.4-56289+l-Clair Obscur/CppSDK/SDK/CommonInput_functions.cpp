...
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// const class UInputMappingContext*       Filter                                                 (ConstParm, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// bool                                    bEnable                                                (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UCommonInputSubsystem::SetPlayerInputForwarderFilter(const class UInputMappingContext* Filter, bool bEnable)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("CommonInputSubsystem", "SetPlayerInputForwarderFilter");

	Params::CommonInputSubsystem_SetPlayerInputForwarderFilter Parms{};
