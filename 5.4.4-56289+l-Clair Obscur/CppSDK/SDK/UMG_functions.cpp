...
const class UTextureRenderTarget2D* URetainerBox::GetRetainerRenderTarget() const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("RetainerBox", "GetRetainerRenderTarget");

	Params::RetainerBox_GetRetainerRenderTarget Parms{};
