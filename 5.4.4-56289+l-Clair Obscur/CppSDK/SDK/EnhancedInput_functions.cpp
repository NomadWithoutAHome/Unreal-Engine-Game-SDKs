...
// (Native, Public, BlueprintCallable)
// Parameters:
// const class FString&                    SettingsSaveSlotName                                   (Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UEnhancedInputUserSettings::SetSettingsSaveSlotName(const class FString& SettingsSaveSlotName)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("EnhancedInputUserSettings", "SetSettingsSaveSlotName");

	Params::EnhancedInputUserSettings_SetSettingsSaveSlotName Parms{};

	Parms.SettingsSaveSlotName = std::move(SettingsSaveSlotName);
