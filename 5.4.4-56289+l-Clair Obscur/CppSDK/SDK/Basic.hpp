...
namespace Offsets
{
	constexpr int32 GObjects          = 0x092DA670;
	constexpr int32 AppendString      = 0x0119D2C0;
	constexpr int32 GNames            = 0x092238C0;
	constexpr int32 GWorld            = 0x09010180;
	constexpr int32 ProcessEvent      = 0x0138CD50;
