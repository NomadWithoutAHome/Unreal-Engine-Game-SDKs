...
// Function UMG.RetainerBox.GetRetainerRenderTarget
// 0x0008 (0x0008 - 0x0000)
struct RetainerBox_GetRetainerRenderTarget final
{
public:
...
static_assert(alignof(RetainerBox_GetRetainerRenderTarget) == 0x000008, "Wrong alignment on RetainerBox_GetRetainerRenderTarget");
static_assert(sizeof(RetainerBox_GetRetainerRenderTarget) == 0x000008, "Wrong size on RetainerBox_GetRetainerRenderTarget");
static_assert(offsetof(RetainerBox_GetRetainerRenderTarget, ReturnValue) == 0x000000, "Member 'RetainerBox_GetRetainerRenderTarget::ReturnValue' has a wrong offset!");
