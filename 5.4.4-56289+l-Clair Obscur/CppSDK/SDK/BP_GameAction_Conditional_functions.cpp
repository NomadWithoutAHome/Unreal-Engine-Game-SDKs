...
#include "BP_GameAction_Conditional_classes.hpp"
#include "BP_GameAction_Conditional_parameters.hpp"
...
TSubclassOf<class UGameActionInstance> UBP_GameAction_Conditional_C::GetInstanceClass()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_GameAction_Conditional_C", "GetInstanceClass");

	Params::BP_GameAction_Conditional_C_GetInstanceClass Parms{};
...
void UBP_GameAction_Conditional_C::ValidateGameAction(TArray<class FText>& ErrorMessages, class FString& PropertyPath, bool& ExploreAssetChildren)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_GameAction_Conditional_C", "ValidateGameAction");

	Params::BP_GameAction_Conditional_C_ValidateGameAction Parms{};
