...
{
public:
	struct FImagePlateParameters                  Plate;                                             // 0x0518(0x0048)(Edit, NoDestructor, NativeAccessSpecifierPrivate)
	uint8                                         Pad_560[0x110];                                    // 0x0560(0x0110)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UImagePlateComponent) == 0x000670, "Wrong size on UImagePlateComponent");
static_assert(offsetof(UImagePlateComponent, Plate) == 0x000518, "Member 'UImagePlateComponent::Plate' has a wrong offset!");
...
static_assert(sizeof(UImagePlateFrustumComponent) == 0x000520, "Wrong size on UImagePlateFrustumComponent");
