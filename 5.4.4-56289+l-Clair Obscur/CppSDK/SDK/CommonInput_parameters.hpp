...
// Function CommonInput.CommonInputSubsystem.SetPlayerInputForwarderFilter
// 0x0010 (0x0010 - 0x0000)
struct CommonInputSubsystem_SetPlayerInputForwarderFilter final
{
public:
	const class UInputMappingContext*             Filter;                                            // 0x0000(0x0008)(ConstParm, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(alignof(CommonInputSubsystem_SetPlayerInputForwarderFilter) == 0x000008, "Wrong alignment on CommonInputSubsystem_SetPlayerInputForwarderFilter");
static_assert(sizeof(CommonInputSubsystem_SetPlayerInputForwarderFilter) == 0x000010, "Wrong size on CommonInputSubsystem_SetPlayerInputForwarderFilter");
static_assert(offsetof(CommonInputSubsystem_SetPlayerInputForwarderFilter, Filter) == 0x000000, "Member 'CommonInputSubsystem_SetPlayerInputForwarderFilter::Filter' has a wrong offset!");
static_assert(offsetof(CommonInputSubsystem_SetPlayerInputForwarderFilter, bEnable) == 0x000008, "Member 'CommonInputSubsystem_SetPlayerInputForwarderFilter::bEnable' has a wrong offset!");
