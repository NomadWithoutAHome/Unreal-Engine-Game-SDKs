...
static_assert(offsetof(FHoudiniExtents, min_0) == 0x000000, "Member 'FHoudiniExtents::min_0' has a wrong offset!");
static_assert(offsetof(FHoudiniExtents, max_0) == 0x000008, "Member 'FHoudiniExtents::max_0' has a wrong offset!");
