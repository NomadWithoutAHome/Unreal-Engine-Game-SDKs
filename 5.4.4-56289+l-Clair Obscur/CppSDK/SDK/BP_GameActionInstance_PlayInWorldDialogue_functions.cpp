...
#include "BP_GameActionInstance_PlayInWorldDialogue_classes.hpp"
#include "BP_GameActionInstance_PlayInWorldDialogue_parameters.hpp"
...
void UBP_GameActionInstance_PlayInWorldDialogue_C::ExecuteUbergraph_BP_GameActionInstance_PlayInWorldDialogue(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_GameActionInstance_PlayInWorldDialogue_C", "ExecuteUbergraph_BP_GameActionInstance_PlayInWorldDialogue");

	Params::BP_GameActionInstance_PlayInWorldDialogue_C_ExecuteUbergraph_BP_GameActionInstance_PlayInWorldDialogue Parms{};
...
bool UBP_GameActionInstance_PlayInWorldDialogue_C::ShouldBlockAutoSaveDuringExecution() const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_GameActionInstance_PlayInWorldDialogue_C", "ShouldBlockAutoSaveDuringExecution");

	Params::BP_GameActionInstance_PlayInWorldDialogue_C_ShouldBlockAutoSaveDuringExecution Parms{};
