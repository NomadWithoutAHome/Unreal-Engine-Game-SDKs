...
// NumValues: 0x0009
enum class InteractiveToolsFramework::EInputDevices : uint32
{
	None                                     = 0,
	Keyboard                                 = 1,
	Mouse                                    = 2,
...
{
public:
	InteractiveToolsFramework::EInputDevices      InputDevice;                                       // 0x0000(0x0004)(BlueprintVisible, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
