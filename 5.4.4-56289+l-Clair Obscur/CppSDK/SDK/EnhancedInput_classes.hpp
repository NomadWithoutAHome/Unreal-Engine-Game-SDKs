...
public:
	...
	class FString                                 SaveSlotName;                                      // 0x0120(0x0010)(ZeroConstructor, Transient, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
public:
	...
	void SetSettingsSaveSlotName(const class FString& SettingsSaveSlotName);
...
static_assert(sizeof(UEnhancedInputUserSettings) == 0x000130, "Wrong size on UEnhancedInputUserSettings");
...
static_assert(offsetof(UEnhancedInputUserSettings, SaveSlotName) == 0x000120, "Member 'UEnhancedInputUserSettings::SaveSlotName' has a wrong offset!");
...
public:
	...
	class FString                                 SettingsSaveSlotName;                              // 0x01E8(0x0010)(ZeroConstructor, Transient, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UEnhancedInputLocalPlayerSubsystem) == 0x0001F8, "Wrong size on UEnhancedInputLocalPlayerSubsystem");
...
static_assert(offsetof(UEnhancedInputLocalPlayerSubsystem, SettingsSaveSlotName) == 0x0001E8, "Member 'UEnhancedInputLocalPlayerSubsystem::SettingsSaveSlotName' has a wrong offset!");
...
{
public:
	TMap<class UInputAction*, struct FKeyConsumptionOptions> KeyConsumptionData;                     // 0x0498(0x0050)(NativeAccessSpecifierPublic)
...
public:
	...
	bool                                          bNeverIgnorePressedKeysUntilRelease;               // 0x0048(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EInputActionValueType                         ValueType;                                         // 0x0049(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, AssetRegistrySearchable, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EInputActionAccumulationBehavior              AccumulationBehavior;                              // 0x004A(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UInputAction, bNeverIgnorePressedKeysUntilRelease) == 0x000048, "Member 'UInputAction::bNeverIgnorePressedKeysUntilRelease' has a wrong offset!");
static_assert(offsetof(UInputAction, ValueType) == 0x000049, "Member 'UInputAction::ValueType' has a wrong offset!");
static_assert(offsetof(UInputAction, AccumulationBehavior) == 0x00004A, "Member 'UInputAction::AccumulationBehavior' has a wrong offset!");
