...
#include "BP_GameAction_PlaySound_classes.hpp"
#include "BP_GameAction_PlaySound_parameters.hpp"
...
void UBP_GameAction_PlaySound_C::ValidateGameAction(TArray<class FText>& ErrorMessages, class FString& PropertyPath, bool& ExploreAssetChildren)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_GameAction_PlaySound_C", "ValidateGameAction");

	Params::BP_GameAction_PlaySound_C_ValidateGameAction Parms{};
...
TSubclassOf<class UGameActionInstance> UBP_GameAction_PlaySound_C::GetInstanceClass()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_GameAction_PlaySound_C", "GetInstanceClass");

	Params::BP_GameAction_PlaySound_C_GetInstanceClass Parms{};
