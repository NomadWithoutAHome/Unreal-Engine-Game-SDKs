...
static_assert(offsetof(UAnimNotifyState_MotionWarping, RootMotionModifier) == 0x000038, "Member 'UAnimNotifyState_MotionWarping::RootMotionModifier' has a wrong offset!");
